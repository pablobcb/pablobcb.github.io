...
Elm.List.Extra.make = function (_elm) {
   ...
   var subsequencesNonEmpty = function (xs) {
      ...
      if (_p32.ctor === "[]") {
            ...
            var f = F2(function (ys,r) {
               return A2($List._op["::"],
               ys,
               A2($List._op["::"],A2($List._op["::"],_p33,ys),r));
            });
            return A2($List._op["::"],
            _U.list([_p33]),
            A3($List.foldr,f,_U.list([]),subsequencesNonEmpty(_p32._1)));
         }
   };
      ...
      transpose: while (true) {
         ...
         if (_p34.ctor === "[]") {
               ...
               if (_p34._0.ctor === "[]") {
                     ...
                     return A2($List._op["::"],
                     A2($List._op["::"],_p34._0._0,heads),
                     transpose(A2($List._op["::"],_p34._0._1,tails)));
                  }
            }
      }
   };
   var intercalate = function (xs) {
      return function (_p36) {
         return $List.concat(A2($List.intersperse,xs,_p36));
      };
   };
   ...
   var findIndex = function (p) {
      return function (_p40) {
         return $List.head(A2(findIndices,p,_p40));
      };
   };
   ...
   var notMember = function (x) {
      return function (_p43) {
         return $Basics.not(A2($List.member,x,_p43));
      };
   };
   ...
   var dropDuplicates = function (list) {
      var step = F2(function (next,_p44) {
         ...
         var _p47 = _p45._0;
         var _p46 = _p45._1;
         return A2($Set.member,next,_p47) ? {ctor: "_Tuple2"
                                            ,_0: _p47
                                            ,_1: _p46} : {ctor: "_Tuple2"
   ...
   var takeWhile = F2(function (predicate,list) {
      ...
      if (_p49.ctor === "[]") {
            ...
            var _p50 = _p49._0;
            return predicate(_p50) ? A2($List._op["::"],
            _p50,
            A2(takeWhile,predicate,_p49._1)) : _U.list([]);
         }
   });
   ...
   var $break = function (p) {
      return span(function (_p51) {
         return $Basics.not(p(_p51));
      });
   };
   ...
   var minimumBy = F2(function (f,ls) {
      var minBy = F3(function (f,x,y) {
         return _U.cmp(f(x),f(y)) < 0 ? x : y;
      });
      var _p55 = ls;
      if (_p55.ctor === "::") {
   ...
   var init = function () {
      var maybe = F2(function (d,f) {
         return function (_p58) {
            return A2($Maybe.withDefault,d,A2($Maybe.map,f,_p58));
         };
      });
      return A2($List.foldr,
      function (_p59) {
...
Elm.Chess.Color.make = function (_elm) {
   ...
   if (_elm.Chess.Color.values) return _elm.Chess.Color.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   $List = Elm.List.make(_elm),
   ...
   return _elm.Chess.Color.values = {_op: _op
                                    ,Black: Black
                                    ,White: White
                                    ,other: other};
};
...
Elm.Chess.Piece.make = function (_elm) {
   ...
   if (_elm.Chess.Piece.values) return _elm.Chess.Piece.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   ...
   var piece = F2(function (f,c) {
      return {figure: f,color: c,moved: false};
   });
   var Piece = F3(function (a,b,c) {
      return {figure: a,moved: b,color: c};
   });
   var King = {ctor: "King"};
   ...
   var Pawn = {ctor: "Pawn"};
   return _elm.Chess.Piece.values = {_op: _op
                                    ,Pawn: Pawn
                                    ,Knight: Knight
                                    ,Bishop: Bishop
                                    ,Rook: Rook
...
Elm.Chess.Board.make = function (_elm) {
   ...
   if (_elm.Chess.Board.values) return _elm.Chess.Board.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Chess$Color = Elm.Chess.Color.make(_elm),
   ...
   var numToChar = function (num) {
      ...
      function (_p0) {
         var _p1 = _p0;
         return _U.eq(_p1._0,num);
      },
      _U.list([{ctor: "_Tuple2",_0: 1,_1: _U.chr("A")}
              ,{ctor: "_Tuple2",_0: 2,_1: _U.chr("B")}
              ,{ctor: "_Tuple2",_0: 3,_1: _U.chr("C")}
              ,{ctor: "_Tuple2",_0: 4,_1: _U.chr("D")}
              ,{ctor: "_Tuple2",_0: 5,_1: _U.chr("E")}
              ,{ctor: "_Tuple2",_0: 6,_1: _U.chr("F")}
              ,{ctor: "_Tuple2",_0: 7,_1: _U.chr("G")}
              ,{ctor: "_Tuple2",_0: 8,_1: _U.chr("H")}])));
   };
   var charToNum = function ($char) {
      ...
      function (_p2) {
         var _p3 = _p2;
         return _U.eq(_p3._0,$char);
      },
      _U.list([{ctor: "_Tuple2",_0: _U.chr("A"),_1: 1}
              ,{ctor: "_Tuple2",_0: _U.chr("B"),_1: 2}
              ,{ctor: "_Tuple2",_0: _U.chr("C"),_1: 3}
              ,{ctor: "_Tuple2",_0: _U.chr("D"),_1: 4}
              ,{ctor: "_Tuple2",_0: _U.chr("E"),_1: 5}
              ,{ctor: "_Tuple2",_0: _U.chr("F"),_1: 6}
              ,{ctor: "_Tuple2",_0: _U.chr("G"),_1: 7}
              ,{ctor: "_Tuple2",_0: _U.chr("H"),_1: 8}])));
   };
   var takeWhileInclusive = F2(function (predicate,xs) {
      var _p4 = xs;
      if (_p4.ctor === "[]") {
            return _U.list([]);
         } else {
            ...
            return A2($List._op["::"],
            _p5,
            predicate(_p5) ? A2(takeWhileInclusive,
            predicate,
            _p4._1) : _U.list([]));
         }
   });
   var getCastlingIntermediatePositions = function (turn) {
      ...
      if (_p6.ctor === "Black") {
            return {ctor: "_Tuple2"
                   ,_0: _U.list([{ctor: "_Tuple2",_0: _U.chr("B"),_1: 1}
                                ,{ctor: "_Tuple2",_0: _U.chr("C"),_1: 1}
                                ,{ctor: "_Tuple2",_0: _U.chr("D"),_1: 1}])
                   ,_1: _U.list([{ctor: "_Tuple2",_0: _U.chr("F"),_1: 1}
                                ,{ctor: "_Tuple2",_0: _U.chr("G"),_1: 1}])};
         } else {
            return {ctor: "_Tuple2"
                   ,_0: _U.list([{ctor: "_Tuple2",_0: _U.chr("B"),_1: 8}
                                ,{ctor: "_Tuple2",_0: _U.chr("C"),_1: 8}
                                ,{ctor: "_Tuple2",_0: _U.chr("D"),_1: 8}])
                   ,_1: _U.list([{ctor: "_Tuple2",_0: _U.chr("F"),_1: 8}
                                ,{ctor: "_Tuple2",_0: _U.chr("G"),_1: 8}])};
         }
   };
   var getRightRookInitialPosition = function (turn) {
      var _p7 = turn;
      if (_p7.ctor === "Black") {
            return {ctor: "_Tuple2",_0: _U.chr("H"),_1: 1};
         } else {
            return {ctor: "_Tuple2",_0: _U.chr("H"),_1: 8};
         }
   };
   var getLeftRookInitialPosition = function (turn) {
      var _p8 = turn;
      if (_p8.ctor === "Black") {
            return {ctor: "_Tuple2",_0: _U.chr("A"),_1: 1};
         } else {
            return {ctor: "_Tuple2",_0: _U.chr("A"),_1: 8};
         }
   };
   var pawnTakeRanges = function (color) {
      var _p9 = color;
      if (_p9.ctor === "Black") {
            return {right: {ctor: "_Tuple2",_0: 1,_1: 1}
                   ,left: {ctor: "_Tuple2",_0: -1,_1: 1}};
         } else {
            return {right: {ctor: "_Tuple2",_0: 1,_1: -1}
                   ,left: {ctor: "_Tuple2",_0: -1,_1: -1}};
         }
   };
   var shift = F2(function (_p11,_p10) {
      var _p12 = _p11;
      var _p13 = _p10;
      var charNumericalRepresentation = function () {
         var _p14 = charToNum(_p12._0);
         if (_p14.ctor === "Just") {
               return _p14._0;
            } else {
               return -9999;
      ...
      var shiftedCharNumericalRepresentation = charNumericalRepresentation + _p13._0;
      var shiftedChar = function () {
         var _p15 = numToChar(shiftedCharNumericalRepresentation);
         if (_p15.ctor === "Just") {
               return _p15._0;
            } else {
               return _U.chr("!");
      ...
      return {ctor: "_Tuple2",_0: shiftedChar,_1: _p12._1 + _p13._1};
   });
   var positionLeft = function (position) {
      return A2(shift,position,{ctor: "_Tuple2",_0: 1,_1: 0});
   };
   var positionRight = function (position) {
      return A2(shift,position,{ctor: "_Tuple2",_0: -1,_1: 0});
   };
   var positionAhead = F2(function (color,position) {
      var _p16 = color;
      if (_p16.ctor === "Black") {
            return A2(shift,position,{ctor: "_Tuple2",_0: 0,_1: 1});
         } else {
            return A2(shift,position,{ctor: "_Tuple2",_0: 0,_1: -1});
         }
   });
   var positionBelow = F2(function (color,position) {
      var _p17 = color;
      if (_p17.ctor === "Black") {
            return A2(shift,position,{ctor: "_Tuple2",_0: 0,_1: -1});
         } else {
   ...
   var emptyRow = A2($List.repeat,8,$Maybe.Nothing);
   var getSquareContent = function (board) {
      return function (_p18) {
         return $Maybe$Extra.join(A3($Basics.flip,
         $Dict.get,
         board,
         _p18));
      };
   };
   var rangeToSquare = F2(function (position,board) {
      return function (_p19) {
         return A2(getSquareContent,board,A2(shift,position,_p19));
      };
   });
   var isPopulated = F2(function (board,position) {
      return function (_p20) {
         return $Maybe$Extra.isJust(A3(rangeToSquare,
         position,
         board,
         _p20));
      };
   });
   var move = F3(function (board,origin,destination) {
      var originSquare = A2(getSquareContent,board,origin);
      ...
      A2($Maybe.map,
      function (piece) {
         return _U.update(piece,{moved: true});
      },
      originSquare),
      board));
      var destinationSquare = A2(getSquareContent,board,destination);
      var takenPiece = destinationSquare;
      return {ctor: "_Tuple2",_0: board$,_1: takenPiece};
   });
   var letters = _U.list([_U.chr("A")
                         ,_U.chr("B")
                         ,_U.chr("C")
                         ,_U.chr("D")
                         ,_U.chr("E")
   ...
   function (digit) {
      return A2($List.map,
      function (letter) {
         return {ctor: "_Tuple2",_0: letter,_1: digit};
      },
      letters);
   },
   _U.range(1,8)));
   var makeInitialBoard = function () {
      var zip$ = function (_p21) {
         var _p22 = _p21;
         return A2($List$Extra.zip,_p22._0,_p22._1);
      };
      var makeRow = function (number) {
         return A2($List$Extra.zip,letters,A2($List.repeat,8,number));
      };
      var makeFirstRow = function (color) {
         return A2($List.map,
         function (_p23) {
            return $Maybe.Just(A3($Basics.flip,
            $Chess$Piece.piece,
            color,
            _p23));
         },
         _U.list([$Chess$Piece.Rook
                 ,$Chess$Piece.Knight
                 ,$Chess$Piece.Bishop
                 ,$Chess$Piece.Queen
                 ,$Chess$Piece.King
      ...
      var pawnRow = function (pawnColor) {
         ...
         8,
         $Maybe.Just(A2($Chess$Piece.piece,
         $Chess$Piece.Pawn,
         pawnColor)));
      };
      ...
      _U.list([{ctor: "_Tuple2"
              ...
              ,{ctor: "_Tuple2",_0: makeRow(6),_1: emptyRow}
              ,{ctor: "_Tuple2",_0: makeRow(5),_1: emptyRow}
              ,{ctor: "_Tuple2",_0: makeRow(4),_1: emptyRow}
              ,{ctor: "_Tuple2",_0: makeRow(3),_1: emptyRow}
              ,{ctor: "_Tuple2"
               ,_0: makeRow(2)
   ...
   var filterPositions = function (positions) {
      var filterPosition = function (pos) {
         ...
         $Basics.fst(pos),
         letters) && A2($List.member,$Basics.snd(pos),_U.range(1,8));
      };
      return A2($List.filter,filterPosition,positions);
   };
   var getRegularDestinations = F4(function (turn,
   board,
   piece,
   position) {
      var kingMoves = _U.list([{ctor: "_Tuple2",_0: 0,_1: 1}
      ...
      var takeWhileEmpty = function (rangesInclusive) {
         ...
         function (_p24) {
            return $Maybe$Extra.isNothing(A3(rangeToSquare,
            position,
            board,
            _p24));
         },
      ...
      var takeWhileEmpty$ = function (_p25) {
         var _p26 = _p25;
         return takeWhileEmpty(A2($List$Extra.zip,_p26._0,_p26._1));
      };
      ...
      var negativeOneToSeven = $List.reverse(_U.range(-7,-1));
      var oneToSeven = _U.range(1,7);
      var bishopMoves = getDirectionalMoves(_U.list([{ctor: "_Tuple2"
                                                     ,_0: oneToSeven
                                                     ,_1: oneToSeven}
                                                    ,{ctor: "_Tuple2",_0: negativeOneToSeven,_1: oneToSeven}
                                                    ,{ctor: "_Tuple2",_0: oneToSeven,_1: negativeOneToSeven}
                                                    ,{ctor: "_Tuple2"
                                                     ,_0: negativeOneToSeven
                                                     ,_1: negativeOneToSeven}]));
      var zeros = A2($List.repeat,7,0);
      var rookMoves = getDirectionalMoves(_U.list([{ctor: "_Tuple2"
                                                   ,_0: oneToSeven
                                                   ,_1: zeros}
                                                  ,{ctor: "_Tuple2",_0: negativeOneToSeven,_1: zeros}
                                                  ,{ctor: "_Tuple2",_0: zeros,_1: oneToSeven}
                                                  ,{ctor: "_Tuple2",_0: zeros,_1: negativeOneToSeven}]));
      var ranges = function () {
         var _p27 = piece.figure;
         switch (_p27.ctor)
         {case "Rook": return rookMoves;
            case "Bishop": return bishopMoves;
            case "Knight": return _U.list([{ctor: "_Tuple2",_0: 1,_1: 2}
            ...
            case "Queen": return A2($Basics._op["++"],
              bishopMoves,
              rookMoves);
            default: var isPopulated$ = A2(isPopulated,board,position);
              var verticalDestinations = F2(function (oneSquareAhead,
              twoSquaresAhead) {
                 return isPopulated$(oneSquareAhead) ? _U.list([]) : isPopulated$(twoSquaresAhead) ? _U.list([oneSquareAhead]) : piece.moved ? _U.list([oneSquareAhead]) : _U.list([oneSquareAhead
                                                                                                                                                                                   ,twoSquaresAhead]);
              });
              var _p28 = piece.color;
              if (_p28.ctor === "Black") {
      ...
      return filterPositions(A2($List.map,shift(position),ranges));
   });
   return _elm.Chess.Board.values = {_op: _op
                                    ,letters: letters
                                    ...
                                    ,getLeftRookInitialPosition: getLeftRookInitialPosition
                                    ,getRightRookInitialPosition: getRightRookInitialPosition
...
Elm.Chess.SpecialMove.make = function (_elm) {
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var makeCastling = F4(function (color,
   board,
   origin,
   destination) {
      var column = $Basics.fst(destination);
      var _p0 = _U.eq(column,_U.chr("C")) ? {ctor: "_Tuple2"
                                            ,_0: $Chess$Board.getLeftRookInitialPosition(color)
                                            ,_1: $Chess$Board.positionLeft(destination)} : {ctor: "_Tuple2"
                                                                                           ,_0: $Chess$Board.getRightRookInitialPosition(color)
                                                                                           ,_1: $Chess$Board.positionRight(destination)};
      var rookOrigin = _p0._0;
      var rookDestination = _p0._1;
      var _p1 = A3($Chess$Board.move,
      boardAfterHookHasMoved,
      rookOrigin,
      rookDestination);
      var boardAfterHookHasMoved = _p1._0;
      var _p2 = A3($Chess$Board.move,board,origin,destination);
      var boardAfterKingHasMoved = _p2._0;
      return boardAfterHookHasMoved;
   });
   var makeEnPassant = F4(function (board,
   origin,
   destination,
   enemyPawnPosition) {
      var _p3 = A3($Chess$Board.move,board,origin,destination);
      var boardAfterPawnHasMoved = _p3._0;
      var boardAfterEnPassant = A3($Dict.insert,
      enemyPawnPosition,
      $Maybe.Nothing,
      boardAfterPawnHasMoved);
      return boardAfterEnPassant;
   });
   var noSpecialMove = {ctor: "_Tuple2"
                       ,_0: _U.list([])
                       ,_1: $Maybe.Nothing};
   var Promotion = function (a) {
      return {ctor: "Promotion",_0: a};
   };
   var Castling = function (a) {
      return {ctor: "Castling",_0: a};
   };
   var EnPassant = function (a) {
      return {ctor: "EnPassant",_0: a};
   };
   return _elm.Chess.SpecialMove.values = {_op: _op
                                          ,EnPassant: EnPassant
                                          ,Castling: Castling
                                          ,Promotion: Promotion
...
Elm.Chess.Game.make = function (_elm) {
   ...
   if (_elm.Chess.Game.values) return _elm.Chess.Game.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Array = Elm.Array.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Chess$Board = Elm.Chess.Board.make(_elm),
   ...
   $Signal = Elm.Signal.make(_elm);
   var _op = {};
   var getKingCastlingArrivalPosition = F3(function (game,
   castlingIntermediatePositions,
   getRookInitialPosition) {
      var intermediatePositionsArray = $Array.fromList(castlingIntermediatePositions);
      var kingLandingPoint = A2($Array.get,
      1,
      intermediatePositionsArray);
      var rookPosition = getRookInitialPosition(game.turn);
      var rookSquare = A2($Chess$Board.getSquareContent,
      game.board,
      rookPosition);
      return $Maybe$Extra.join(A3($Basics.flip,
      $Maybe.map,
      rookSquare,
      function (piece) {
         if ($Basics.not(_U.eq(piece.figure,
         $Chess$Piece.Rook) && _U.eq(piece.moved,false)))
         return $Maybe.Nothing; else {
               var isIntermediateCastlingSquaresEmpty = _U.eq(0,
               $List.length(A2($List.filter,
               function (_p0) {
                  return $Maybe$Extra.isJust(A2($Chess$Board.getSquareContent,
                  game.board,
                  _p0));
               },
               castlingIntermediatePositions)));
               return $Basics.not(isIntermediateCastlingSquaresEmpty) ? $Maybe.Nothing : kingLandingPoint;
            }
      }));
   });
   var noSpecialMove = {ctor: "_Tuple2"
                       ,_0: _U.list([])
                       ,_1: $Maybe.Nothing};
   var getCastlingDestinations = F3(function (game,origin,king) {
      if (king.moved) return noSpecialMove; else {
            var _p1 = $Chess$Board.getCastlingIntermediatePositions(game.turn);
            var leftCastlingIntermediatePositions = _p1._0;
            var rightCastlingIntermediatePositions = _p1._1;
            var leftKingCastlingArrivalPosition = A3(getKingCastlingArrivalPosition,
            game,
            leftCastlingIntermediatePositions,
            $Chess$Board.getLeftRookInitialPosition);
            var rightKingCastlingArrivalPosition = A3(getKingCastlingArrivalPosition,
            game,
            rightCastlingIntermediatePositions,
            $Chess$Board.getLeftRookInitialPosition);
            var castlingPositions = A2($Basics._op["++"],
            $Maybe$Extra.maybeToList(leftKingCastlingArrivalPosition),
            $Maybe$Extra.maybeToList(rightKingCastlingArrivalPosition));
            var noCastling = _U.eq(castlingPositions,_U.list([]));
            return noCastling ? noSpecialMove : {ctor: "_Tuple2"
                                                ,_0: castlingPositions
                                                ,_1: $Maybe.Just($Chess$SpecialMove.Castling({ctor: "_Tuple2"
                                                                                             ,_0: leftKingCastlingArrivalPosition
                                                                                             ,_1: rightKingCastlingArrivalPosition}))};
         }
   });
   var getPawnValidTakes = F2(function (game,origin) {
      var canTakeTo = function (f) {
         var range = f($Chess$Board.pawnTakeRanges(game.turn));
         var enemyPiece = A2($Chess$Board.getSquareContent,
         game.board,
         A2($Chess$Board.shift,origin,range));
         return $Maybe$Extra.isJust(enemyPiece) ? _U.list([A2($Chess$Board.shift,
         origin,
         range)]) : _U.list([]);
      };
      var pawnTakePositions = A2($Basics._op["++"],
      canTakeTo(function (_) {    return _.left;}),
      canTakeTo(function (_) {    return _.right;}));
      return pawnTakePositions;
   });
   var getPawnSpecialDestinations = F2(function (game,origin) {
      var nextPosition = A2($Chess$Board.positionAhead,
      game.turn,
      origin);
      var nextRow = $Basics.snd(nextPosition);
      var right = $Chess$Board.positionRight(origin);
      var left = $Chess$Board.positionLeft(origin);
      var _p2 = function () {
         if (_U.eq(nextRow,1) || _U.eq(nextRow,8))
         return {ctor: "_Tuple2"
                ,_0: _U.list([])
                ,_1: $Maybe.Just($Chess$SpecialMove.Promotion(nextPosition))};
         else {
               var _p3 = game.state;
               if (_p3.ctor === "Origin" && _p3._0.ctor === "Just") {
                     var _p5 = _p3._0._0;
                     if (_U.eq(_p5,left) || _U.eq(_p5,right)) {
                           var enPassantDestination = A2($Chess$Board.shift,
                           _p5,
                           function () {
                              var _p4 = game.turn;
                              if (_p4.ctor === "Black") {
                           ...
                           return {ctor: "_Tuple2"
                                  ,_0: _U.list([enPassantDestination])
                                  ,_1: $Maybe.Just($Chess$SpecialMove.EnPassant(enPassantDestination))};
                        } else return noSpecialMove;
                  } else {
                     return noSpecialMove;
                  }
            }
      }();
      var specialDestinations = _p2._0;
      var specialMove = _p2._1;
      var destinations = A2($Basics._op["++"],
      A2(getPawnValidTakes,game,origin),
      specialDestinations);
      return {ctor: "_Tuple2",_0: destinations,_1: specialMove};
   });
   var getSpecialDestinations = F3(function (game,origin,piece) {
      var _p6 = piece.figure;
      switch (_p6.ctor)
      {case "Pawn": return A2(getPawnSpecialDestinations,game,origin);
         case "King": return A3(getCastlingDestinations,
           game,
           origin,
           piece);
         default: return noSpecialMove;}
   });
   var getValidDestinations = F3(function (game,origin,piece) {
      var destinationHasNoAlly = function (destination) {
         var _p7 = A2($Chess$Board.getSquareContent,
         game.board,
         destination);
         if (_p7.ctor === "Just") {
               return !_U.eq(_p7._0.color,game.turn);
            } else {
               return true;
            }
      };
      ...
      var _p8 = A3(getSpecialDestinations,game,origin,piece);
      var specialDestinations = _p8._0;
      var specialMove = _p8._1;
      ...
      A2($Basics._op["++"],regularDestinations,specialDestinations));
      return {ctor: "_Tuple2",_0: validDestinations,_1: specialMove};
   });
   ...
   var updateGraveyard = F2(function (game,deadFigure) {
      var _p9 = game.turn;
      if (_p9.ctor === "White") {
            return _U.update(game,
            {graveyard2: A2($Basics._op["++"],
            game.graveyard2,
            _U.list([deadFigure]))});
         } else {
            return _U.update(game,
            {graveyard1: A2($Basics._op["++"],
            game.graveyard1,
            _U.list([deadFigure]))});
         }
   });
   var handleMove = F3(function (game,origin,destination) {
      var _p10 = A3($Chess$Board.move,
      game.board,
      origin,
      destination);
      var board = _p10._0;
      var takenPiece = _p10._1;
      var game$ = _U.update(game,{board: board});
      var _p11 = takenPiece;
      if (_p11.ctor === "Nothing") {
            return game$;
         } else {
            return A2(updateGraveyard,game$,_p11._0.figure);
         }
   });
   var handleCastling = F5(function (game,
   originPosition,
   selectedPosition,
   kingLeftPosition,
   kingRightPosition) {
      var doCastling = F3(function (game,origin,destination) {
         return _U.update(game,
         {board: A4($Chess$SpecialMove.makeCastling,
         game.turn,
         game.board,
         origin,
         destination)});
      });
      var _p12 = kingLeftPosition;
      if (_p12.ctor === "Just") {
            var _p13 = _p12._0;
            return _U.eq(selectedPosition,_p13) ? A3(doCastling,
            game,
            originPosition,
            _p13) : game;
         } else {
            var _p14 = kingRightPosition;
            if (_p14.ctor === "Just") {
                  var _p15 = _p14._0;
                  return _U.eq(selectedPosition,_p15) ? A3(doCastling,
                  game,
                  originPosition,
                  _p15) : game;
               } else {
                  return _U.crashCase("Chess.Game",
                  {start: {line: 157,column: 9},end: {line: 166,column: 42}},
                  _p14)("castling special move without both\n              arguments being Nothing!");
               }
         }
   });
   ...
   var resetClock = function (game) {
      return _U.update(game,{turnInSeconds: 0});
   };
   var passTurn = function (game) {
      return resetClock(_U.update(game,
      {previousState: game.state
      ,turn: $Chess$Color.other(game.turn)}));
   };
   ...
   var SelectPromotion = function (a) {
      return {ctor: "SelectPromotion",_0: a};
   };
   var Destination = F3(function (a,b,c) {
      return {ctor: "Destination",_0: a,_1: b,_2: c};
   });
   var setValidDestinations = F2(function (game,selectedPosition) {
      var selectedSquare = A2($Chess$Board.getSquareContent,
      game.board,
      selectedPosition);
      var _p17 = selectedSquare;
      if (_p17.ctor === "Nothing") {
            return game;
         } else {
            var _p19 = _p17._0;
            if (!_U.eq(game.turn,_p19.color)) return game; else {
                  var _p18 = A3(getValidDestinations,
                  game,
                  selectedPosition,
                  _p19);
                  var validDestinations = _p18._0;
                  var specialMove = _p18._1;
                  return _U.update(game,
                  {state: A3(Destination,
                  selectedPosition,
                  validDestinations,
                  specialMove)});
               }
   ...
   var waitForPieceSelection = F2(function (positionOfPawnWichMoved2Squares,
   game) {
      return passTurn(_U.update(game,
      {state: Origin(positionOfPawnWichMoved2Squares)}));
   });
   var handleEnPassant = F3(function (game,
   originPosition,
   selectedPosition) {
      var enemyPawnPosition = A2($Chess$Board.positionBelow,
      game.turn,
      selectedPosition);
      var board = A4($Chess$SpecialMove.makeEnPassant,
      game.board,
      originPosition,
      selectedPosition,
      enemyPawnPosition);
      var gameAfterEnPassant = _U.update(game,{board: board});
      return A2(waitForPieceSelection,
      $Maybe.Nothing,
      gameAfterEnPassant);
   });
   ...
   specialMove) {
      ...
      selectedPosition);
      var isPawn = function () {
         var _p20 = selectedDestination;
         if (_p20.ctor === "Just") {
               return _U.eq(_p20._0.figure,
      ...
      selectedPosition,
      validDestinations);
      if ($Basics.not(isPositionValid)) return _U.update(game,
         {state: game.previousState}); else {
            var _p22 = specialMove;
            if (_p22.ctor === "Nothing") {
                  return $Basics.not(isPawn) ? A2(waitForPieceSelection,
                  $Maybe.Nothing,
                  game$) : hasMovedTwoSquares ? A2(waitForPieceSelection,
                  $Maybe.Just(selectedPosition),
                  game$) : A2(waitForPieceSelection,$Maybe.Nothing,game$);
               } else {
                  switch (_p22._0.ctor)
                  {case "Promotion": return _U.update(game$,
                       {previousState: game$.state
                       ,state: SelectPromotion(_p22._0._0)});
                     case "EnPassant": if (_U.eq(selectedPosition,_p22._0._0))
                       return A3(handleEnPassant,game,originPosition,selectedPosition);
                       else {
                             var selectedDestination = A2($Chess$Board.getSquareContent,
                             game$.board,
                             selectedPosition);
                             var isPawn = function () {
                                var _p23 = selectedDestination;
                                if (_p23.ctor === "Just") {
                                      return _U.eq(_p23._0.figure,
                                      $Chess$Piece.Pawn) ? true : false;
                                   } else {
                                      return false;
                                   }
                             }();
                             return passTurn($Basics.not(isPawn) ? A2(waitForPieceSelection,
                             $Maybe.Nothing,
                             game$) : hasMovedTwoSquares ? A2(waitForPieceSelection,
                             $Maybe.Just(selectedPosition),
                             game$) : A2(waitForPieceSelection,$Maybe.Nothing,game$));
                          }
                     default: return A2(waitForPieceSelection,
                       $Maybe.Nothing,
                       A5(handleCastling,
                       game,
                       originPosition,
   ...
   var handleClick = F2(function (game,selectedPosition) {
      var _p24 = game.state;
      switch (_p24.ctor)
      {case "SelectPromotion": return game;
         case "Origin": return A2(setValidDestinations,
           game,
           selectedPosition);
         case "Destination": return A5(handleDestination,
           game,
           selectedPosition,
           _p24._0,
           _p24._1,
           _p24._2);
         case "CheckMate": return game;
         default: return game;}
   });
   var promotePiece = F3(function (game,
   promotedPiecePosition,
   figure) {
      var promotedTo = $Maybe.Just({figure: figure
                                   ,moved: true
                                   ,color: game.turn});
      var board$ = A3($Dict.insert,
      promotedPiecePosition,
      ...
      game.board);
      return passTurn(_U.update(game,
      {board: board$,state: Origin($Maybe.Nothing)}));
   });
   var makeInitialGame = function () {
      var emptyGraveyard = _U.list([]);
      return {board: $Chess$Board.makeInitialBoard
   ...
   return _elm.Chess.Game.values = {_op: _op
                                   ,Origin: Origin
                                   ...
                                   ,handleEnPassant: handleEnPassant
                                   ...
                                   ,noSpecialMove: noSpecialMove
                                   ,getKingCastlingArrivalPosition: getKingCastlingArrivalPosition
                                   ,getCastlingDestinations: getCastlingDestinations
...
Elm.Update.make = function (_elm) {
   ...
   var update = F2(function (action,game) {
      var _p0 = action;
      switch (_p0.ctor)
      {case "UpdateTimer": return $Chess$Game.tick(game);
         case "Promote": return A3($Chess$Game.promotePiece,
           game,
           _p0._0,
           _p0._1);
         default: return A2($Chess$Game.handleClick,game,_p0._0);}
   });
   var Click = function (a) {    return {ctor: "Click",_0: a};};
   var Promote = F2(function (a,b) {
      return {ctor: "Promote",_0: a,_1: b};
   });
...
Elm.View = Elm.View || {};
Elm.View.Piece = Elm.View.Piece || {};
Elm.View.Piece.make = function (_elm) {
   "use strict";
   _elm.View = _elm.View || {};
   _elm.View.Piece = _elm.View.Piece || {};
   if (_elm.View.Piece.values) return _elm.View.Piece.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Chess$Piece = Elm.Chess.Piece.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   return _elm.View.Piece.values = {_op: _op
                                   ,getPieceClass: getPieceClass};
};
Elm.View = Elm.View || {};
Elm.View.StatusBar = Elm.View.StatusBar || {};
Elm.View.StatusBar.make = function (_elm) {
   "use strict";
   _elm.View = _elm.View || {};
   _elm.View.StatusBar = _elm.View.StatusBar || {};
   if (_elm.View.StatusBar.values)
   return _elm.View.StatusBar.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Chess$Game = Elm.Chess.Game.make(_elm),
   $Debug = Elm.Debug.make(_elm),
   ...
   var _op = {};
   var turnLabel = function (game) {
      return $String.toLower($Basics.toString(game.turn));
   };
   var turn = function (game) {
      var turn = A2($Basics._op["++"],turnLabel(game),"s’ turn");
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("status-bar__turn")]),
      _U.list([$Html.text(turn)]));
   };
   var formatTime = function (time) {
      var time$ = function (f) {
         return $Basics.toString(A2(f,time,60));
      };
      var minutes = time$(F2(function (x,y) {    return x / y | 0;}));
      var ensure2digits = function (str) {
         return _U.eq($String.length(str),1) ? A2($Basics._op["++"],
         "0",
         str) : str;
      };
      ...
      minutes,
      A2($Basics._op["++"],":",seconds));
      return parsedTime;
   };
   var clock = function (game) {
      var time = $Html.text(formatTime(game.turnInSeconds));
      var icon = A2($Html.span,
      _U.list([$Html$Attributes.$class("fa fa-clock-o status-bar__clock-icon")]),
      _U.list([]));
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("status-bar__clock")]),
      _U.list([icon,time]));
   };
   var renderStatusBar = F2(function (address,game) {
      ...
      var statusMsg = function () {
         var _p0 = game.state;
         switch (_p0.ctor)
         {case "Origin": return _U.list([$Html.text("select a piece")]);
            case "Destination":
            return _U.list([$Html.text("select a destination")]);
            case "SelectPromotion":
            return _U.list([$Html.text("select a piece")]);
            case "Finished":
            return _U.list([$Html.text(A2($Basics._op["++"],
              "The game has ended, ",
              A2($Basics._op["++"],$Basics.toString(_p0._0)," has won!")))]);
            default: return _U.list([]);}
      }();
      var content = _U.list([clock(game)
                            ,A2($Html.div,
                            _U.list([$Html$Attributes.$class("status-bar__message")]),
                            statusMsg)
                            ,turn(game)]);
      return A2($Html.div,
   ...
   return _elm.View.StatusBar.values = {_op: _op
...
Elm.View = Elm.View || {};
Elm.View.Graveyard = Elm.View.Graveyard || {};
Elm.View.Graveyard.make = function (_elm) {
   "use strict";
   _elm.View = _elm.View || {};
   _elm.View.Graveyard = _elm.View.Graveyard || {};
   if (_elm.View.Graveyard.values)
   return _elm.View.Graveyard.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Chess$Color = Elm.Chess.Color.make(_elm),
   $Chess$Game = Elm.Chess.Game.make(_elm),
   ...
   $String = Elm.String.make(_elm);
   var _op = {};
   var renderGraveyardPiece = F2(function (color,figure) {
      var style = A2($Basics._op["++"],
      "graveyard square piece ",
      A2($Basics._op["++"],
      $String.toLower($Basics.toString(figure)),
      A2($Basics._op["++"],
      " ",
      A2($Basics._op["++"],
      $String.toLower($Basics.toString(color)),
      " "))));
      return A2($Html.div,
      _U.list([$Html$Attributes.$class(style)]),
      _U.list([]));
   });
   var renderGraveyard = F2(function (graveyard,color) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class(A2(F2(function (x,y) {
         return A2($Basics._op["++"],x,y);
      }),
      "graveyard ",
      $String.toLower($Basics.toString(color))))]),
      A2($List.map,renderGraveyardPiece(color),graveyard));
   });
   return _elm.View.Graveyard.values = {_op: _op
                                       ,renderGraveyardPiece: renderGraveyardPiece
                                       ,renderGraveyard: renderGraveyard};
};
Elm.View = Elm.View || {};
Elm.View.Board = Elm.View.Board || {};
Elm.View.Board.make = function (_elm) {
   "use strict";
   _elm.View = _elm.View || {};
   _elm.View.Board = _elm.View.Board || {};
   if (_elm.View.Board.values) return _elm.View.Board.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Chess$Board = Elm.Chess.Board.make(_elm),
   $Chess$Color = Elm.Chess.Color.make(_elm),
   ...
   $String = Elm.String.make(_elm),
   $Update = Elm.Update.make(_elm),
   $View$Piece = Elm.View.Piece.make(_elm);
   var _op = {};
   var renderGutterItem = function (label) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("chessboard__gutter__item")]),
      _U.list([$Html.text(label)]));
   };
   var renderGutterHorizontal = A2($List.map,
   renderGutterItem,
   _U.list(["A","B","C","D","E","F","G","H"]));
   var renderGutterVertical = A2($List.map,
   renderGutterItem,
   _U.list(["1","2","3","4","5","6","7","8"]));
   var renderGutter = function (placement) {
      var _p0 = placement;
      switch (_p0.ctor)
      {case "Top": return A2($Html.div,
           _U.list([$Html$Attributes.$class("chessboard__gutter top")]),
           renderGutterHorizontal);
         case "Left": return A2($Html.div,
           _U.list([$Html$Attributes.$class("chessboard__gutter left")]),
           renderGutterVertical);
         case "Right": return A2($Html.div,
           _U.list([$Html$Attributes.$class("chessboard__gutter right")]),
           renderGutterVertical);
         default: return A2($Html.div,
           _U.list([$Html$Attributes.$class("chessboard__gutter bottom ")]),
           renderGutterHorizontal);}
   };
   ...
   position,
   square) {
      var emitPosition = A2($Html$Events.onClick,
      address,
      $Update.Click(position));
      var highlight = function () {
         var _p1 = state;
         if (_p1.ctor === "Destination") {
               return A2($List.member,position,_p1._1) || _U.eq(position,
               _p1._0) ? "valid-destination" : "";
            } else {
               return "";
            }
      }();
      var renderSquare = function (pieceStyle) {
         return A2($Html.div,
         _U.list([$Html$Attributes.$class(A2($String.join,
                 " ",
                 _U.list(["square",highlight,pieceStyle])))
                 ,emitPosition]),
         _U.list([]));
      };
      var _p2 = square;
      if (_p2.ctor === "Nothing") {
            ...
            return renderSquare($View$Piece.getPieceClass(_p2._0));
         }
   });
   ...
   var Top = {ctor: "Top"};
   var renderBoard = F4(function (address,turn,state,board) {
      var highlight = function () {
         var _p3 = state;
         if (_p3.ctor === "Origin") {
      ...
      " ",
      _U.list(["chessboard",highlight]));
      var positions = $Chess$Board.getPositions;
      var pieces = A2($List.map,
      $Chess$Board.getSquareContent(board),
      positions);
      var squares = A3($List.map2,
      A2(renderBoardSquare,address,state),
      positions,
      pieces);
      return A2($Html.div,
      _U.list([$Html$Attributes.$class(className)]),
      _U.list([renderGutter(Left)
              ,renderGutter(Top)
              ,A2($Html.div,
              _U.list([$Html$Attributes.$class("chessboard__grid")]),
              squares)
              ,renderGutter(Right)
              ,renderGutter(Bottom)]));
   });
   return _elm.View.Board.values = {_op: _op
                                   ...
                                   ,renderGutterHorizontal: renderGutterHorizontal
                                   ,renderGutterVertical: renderGutterVertical
                                   ,renderGutter: renderGutter
                                   ,renderBoard: renderBoard};
};
Elm.View = Elm.View || {};
Elm.View.Promotion = Elm.View.Promotion || {};
Elm.View.Promotion.make = function (_elm) {
   "use strict";
   _elm.View = _elm.View || {};
   _elm.View.Promotion = _elm.View.Promotion || {};
   if (_elm.View.Promotion.values)
   return _elm.View.Promotion.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Chess$Game = Elm.Chess.Game.make(_elm),
   $Chess$Piece = Elm.Chess.Piece.make(_elm),
   ...
   $View$Piece = Elm.View.Piece.make(_elm);
   var _op = {};
   var renderPromotion = F2(function (address,game) {
      var _p0 = game.state;
      if (_p0.ctor === "SelectPromotion") {
            var getClass = function (piece) {
               return A2($String.join,
               " ",
               _U.list(["square"
                       ,"promotion__piece"
                       ,$View$Piece.getPieceClass(piece)]));
            };
            var handleClick = function (piece) {
               return A2($Html$Events.onClick,
               address,
               A2($Update.Promote,_p0._0,piece.figure));
            };
            var renderPromotionButton = function (piece) {
               return A2($Html.div,
               _U.list([$Html$Attributes.$class(getClass(piece))
                       ,handleClick(piece)]),
               _U.list([]));
            };
            return A2($Html.div,
            _U.list([$Html$Attributes.$class("promotion active")]),
            _U.list([A2($Html.div,
                    _U.list([$Html$Attributes.$class("promotion__label")]),
                    _U.list([$Html.text("Promotion")]))
                    ,A2($Html.div,
                    _U.list([$Html$Attributes.$class("promotion__pieces")]),
                    _U.list([renderPromotionButton(A2($Chess$Piece.piece,
                            $Chess$Piece.Queen,
                            game.turn))
                            ,renderPromotionButton(A2($Chess$Piece.piece,
                            $Chess$Piece.Knight,
                            game.turn))]))]));
         } else {
            return A2($Html.div,
            _U.list([$Html$Attributes.$class("promotion")]),
            _U.list([]));
         }
   });
   return _elm.View.Promotion.values = {_op: _op
                                       ,renderPromotion: renderPromotion};
};
Elm.View = Elm.View || {};
Elm.View.Game = Elm.View.Game || {};
Elm.View.Game.make = function (_elm) {
   "use strict";
   _elm.View = _elm.View || {};
   _elm.View.Game = _elm.View.Game || {};
   if (_elm.View.Game.values) return _elm.View.Game.values;
   var _U = Elm.Native.Utils.make(_elm),
   $Basics = Elm.Basics.make(_elm),
   $Chess$Color = Elm.Chess.Color.make(_elm),
   $Chess$Game = Elm.Chess.Game.make(_elm),
   ...
   $View$Graveyard = Elm.View.Graveyard.make(_elm),
   $View$Promotion = Elm.View.Promotion.make(_elm),
   $View$StatusBar = Elm.View.StatusBar.make(_elm);
   var _op = {};
   var renderGame = F2(function (address,game) {
      return A2($Html.div,
      _U.list([$Html$Attributes.$class("game")]),
      _U.list([A2($Html.div,
              _U.list([$Html$Attributes.$class("board-and-graveyard")]),
              _U.list([A2($View$Graveyard.renderGraveyard,
                      game.graveyard2,
                      $Chess$Color.Black)
                      ,A4($View$Board.renderBoard,
                      address,
                      game.turn,
                      game.state,
                      game.board)
                      ,A2($View$Graveyard.renderGraveyard,
                      game.graveyard1,
                      $Chess$Color.White)]))
              ,A2($View$StatusBar.renderStatusBar,address,game)
              ,A2($View$Promotion.renderPromotion,address,game)]));
   });
   return _elm.View.Game.values = {_op: _op
...
Elm.Main.make = function (_elm) {
   ...
   $Update = Elm.Update.make(_elm),
   $View$Game = Elm.View.Game.make(_elm);
   var _op = {};
   ...
   A2($Signal.merge,actions,ticker));
   var main = A2($Signal.map,
   $View$Game.renderGame(inbox.address),
   model);
