...
var _pablobcb$elm_lead$Component_Knob$knobStyle = _elm_lang$core$Native_List.fromArray(
	[
		{ctor: '_Tuple2', _0: '-webkit-user-drag', _1: 'element'},
		{ctor: '_Tuple2', _0: '-webkit-user-select', _1: 'none'}
	]);
var _pablobcb$elm_lead$Component_Knob$create = F4(
	function (value, min, max, step) {
		return {value: value, min: min, max: max, step: step, yPos: 0};
	});
var _pablobcb$elm_lead$Component_Knob$Model = F5(
	function (a, b, c, d, e) {
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$html$Html_Attributes$style(_pablobcb$elm_lead$Component_Knob$knobStyle),
...
var _pablobcb$elm_lead$Container_Panel_Model$setOscillator2Waveform = F2(
	function (model, waveform) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{oscillator2Waveform: waveform});
	});
var _pablobcb$elm_lead$Container_Panel_Model$setOscillator1Waveform = F2(
	function (model, waveform) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{oscillator1Waveform: waveform});
	});
var _pablobcb$elm_lead$Container_Panel_Model$setOscillatorsMix = F2(
	function (knobModel, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{oscillatorsMixKnob: knobModel});
	});
var _pablobcb$elm_lead$Container_Panel_Model$setMasterVolume = F2(
	function (knobModel, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{masterVolumeKnob: knobModel});
	});
var _pablobcb$elm_lead$Container_Panel_Model$setOscillator2Semitone = F2(
	function (knobModel, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{oscillator2SemitoneKnob: knobModel});
	});
var _pablobcb$elm_lead$Container_Panel_Model$setOscillator2Detune = F2(
	function (knobModel, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{oscillator2DetuneKnob: knobModel});
	});
var _pablobcb$elm_lead$Container_Panel_Model$setPulseWidth = F2(
	function (knobModel, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{oscillator2DetuneKnob: knobModel});
	});
var _pablobcb$elm_lead$Container_Panel_Model$setFmAmount = F2(
	function (knobModel, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
											...
											return function (l) {
												return function (m) {
													return function (n) {
														return function (o) {
															return function (p) {
																return {oscillatorsMixKnob: a, oscillator1Waveform: b, oscillator2SemitoneKnob: c, oscillator2DetuneKnob: d, oscillator2Waveform: e, pulseWidthKnob: f, fmAmountKnob: g, ampAttackKnob: h, ampDecayKnob: i, ampSustainKnob: j, ampReleaseKnob: k, masterVolumeKnob: l, filterAttackKnob: m, filterDecayKnob: n, filterSustainKnob: o, filterReleaseKnob: p};
															};
														};
													};
												};
...
var _pablobcb$elm_lead$Container_Panel_Model$init = {
	oscillatorsMixKnob: A4(_pablobcb$elm_lead$Component_Knob$create, 0, -50, 50, 1),
	oscillator2SemitoneKnob: A4(_pablobcb$elm_lead$Component_Knob$create, 0, -60, 60, 1),
	oscillator2DetuneKnob: A4(_pablobcb$elm_lead$Component_Knob$create, 0, -100, 100, 1),
	oscillator1Waveform: _pablobcb$elm_lead$Container_Panel_Model$Sawtooth,
	oscillator2Waveform: _pablobcb$elm_lead$Container_Panel_Model$Sawtooth,
	fmAmountKnob: A4(_pablobcb$elm_lead$Component_Knob$create, 0, 0, 100, 1),
	pulseWidthKnob: A4(_pablobcb$elm_lead$Component_Knob$create, 0, 0, 100, 1),
	ampAttackKnob: A4(_pablobcb$elm_lead$Component_Knob$create, 0, 0, 100, 1),
	ampDecayKnob: A4(_pablobcb$elm_lead$Component_Knob$create, 0, 0, 100, 1),
	ampSustainKnob: A4(_pablobcb$elm_lead$Component_Knob$create, 0, 0, 100, 1),
	ampReleaseKnob: A4(_pablobcb$elm_lead$Component_Knob$create, 0, 0, 100, 1),
	masterVolumeKnob: A4(_pablobcb$elm_lead$Component_Knob$create, 10, 0, 100, 1),
	filterAttackKnob: A4(_pablobcb$elm_lead$Component_Knob$create, 0, 0, 100, 1),
	filterDecayKnob: A4(_pablobcb$elm_lead$Component_Knob$create, 0, 0, 100, 1),
	filterSustainKnob: A4(_pablobcb$elm_lead$Component_Knob$create, 0, 0, 100, 1),
	filterReleaseKnob: A4(_pablobcb$elm_lead$Component_Knob$create, 0, 0, 100, 1)
};
...
var _pablobcb$elm_lead$Container_OnScreenKeyboard_View$getKeyClass = F3(
...
var _pablobcb$elm_lead$Container_OnScreenKeyboard_View$key = F3(
	function (model, noteName, midiNote) {
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					A3(_pablobcb$elm_lead$Container_OnScreenKeyboard_View$getKeyClass, model, noteName, midiNote)),
...
var _pablobcb$elm_lead$Container_OnScreenKeyboard_View$midiNotes = _elm_lang$core$Native_List.range(0, 127);
...
var _pablobcb$elm_lead$Container_OnScreenKeyboard_View$view = function (model) {
	var keys = A3(
		...
		_pablobcb$elm_lead$Container_OnScreenKeyboard_View$midiNotes);
	return A2(
		_elm_lang$html$Html$div,
		_elm_lang$core$Native_List.fromArray(
			[]),
		...
		switch (_p1.ctor) {
			case 'MasterVolumeChange':
				return A5(
					...
					_pablobcb$elm_lead$Container_Panel_Model$setMasterVolume,
			...
			case 'OscillatorsMixChange':
				return A5(
					...
					_pablobcb$elm_lead$Container_Panel_Model$setOscillatorsMix,
			...
			case 'Oscillator2SemitoneChange':
				return A5(
					...
					_pablobcb$elm_lead$Container_Panel_Model$setOscillator2Semitone,
			...
			case 'Oscillator2DetuneChange':
				return A5(
					...
					_pablobcb$elm_lead$Container_Panel_Model$setOscillator2Detune,
			...
			case 'FMAmountChange':
				return A5(
					...
					_pablobcb$elm_lead$Container_Panel_Model$setFmAmount,
			...
			case 'PulseWidthChange':
				return A5(
					...
					_pablobcb$elm_lead$Container_Panel_Model$setPulseWidth,
					_pablobcb$elm_lead$Container_Panel_Update$PulseWidthChange);
			case 'Oscillator1WaveformChange':
				var _p2 = _p1._0;
				return {
					ctor: '_Tuple2',
					_0: A2(_pablobcb$elm_lead$Container_Panel_Model$setOscillator1Waveform, model, _p2),
					_1: _pablobcb$elm_lead$Port$oscillator1WaveformPort(
			...
			default:
				...
				return {
					ctor: '_Tuple2',
					_0: A2(_pablobcb$elm_lead$Container_Panel_Model$setOscillator2Waveform, model, _p3),
					_1: _pablobcb$elm_lead$Port$oscillator2WaveformPort(
...
var _pablobcb$elm_lead$Container_Panel_View$waveformSelector = F4(
...
var _pablobcb$elm_lead$Container_Panel_View$oscillator1Waveform = A2(
	_pablobcb$elm_lead$Container_Panel_View$waveformSelector,
	_elm_lang$core$Native_List.fromArray(
		[_pablobcb$elm_lead$Container_Panel_Model$Sawtooth, _pablobcb$elm_lead$Container_Panel_Model$Sine, _pablobcb$elm_lead$Container_Panel_Model$Triangle, _pablobcb$elm_lead$Container_Panel_Model$Square]),
	function (_) {
		return _.oscillator1Waveform;
	});
var _pablobcb$elm_lead$Container_Panel_View$oscillator2Waveform = A2(
	_pablobcb$elm_lead$Container_Panel_View$waveformSelector,
	_elm_lang$core$Native_List.fromArray(
		[_pablobcb$elm_lead$Container_Panel_Model$Sawtooth, _pablobcb$elm_lead$Container_Panel_Model$Triangle, _pablobcb$elm_lead$Container_Panel_Model$Square]),
	function (_) {
...
var _pablobcb$elm_lead$Container_Panel_View$amplifier = function (model) {
	var knob = A2(
		_pablobcb$elm_lead$Container_Panel_View$nordKnob,
		_elm_lang$core$Basics$always(_pablobcb$elm_lead$Container_Panel_Update$MasterVolumeChange),
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				A4(_pablobcb$elm_lead$Container_Panel_View$nordKnob, _pablobcb$elm_lead$Container_Panel_Update$MasterVolumeChange, _pablobcb$elm_lead$Port$masterVolumePort, model.masterVolumeKnob, 'gain')
			]));
};
...
var _pablobcb$elm_lead$Container_Panel_View$oscillators = function (model) {
	return A2(
		_pablobcb$elm_lead$Container_Panel_View$section,
		'oscillators',
		_elm_lang$core$Native_List.fromArray(
			[
				A2(_pablobcb$elm_lead$Container_Panel_View$oscillator1Waveform, model, _pablobcb$elm_lead$Container_Panel_Update$Oscillator1WaveformChange),
				A2(_pablobcb$elm_lead$Container_Panel_View$oscillator2Waveform, model, _pablobcb$elm_lead$Container_Panel_Update$Oscillator2WaveformChange),
				...
				A4(_pablobcb$elm_lead$Container_Panel_View$nordKnob, _pablobcb$elm_lead$Container_Panel_Update$FMAmountChange, _pablobcb$elm_lead$Port$fmAmountPort, model.fmAmountKnob, 'FM'),
				A4(_pablobcb$elm_lead$Container_Panel_View$nordKnob, _pablobcb$elm_lead$Container_Panel_Update$PulseWidthChange, _pablobcb$elm_lead$Port$pulseWidthPort, model.pulseWidthKnob, 'PW')
			]));
};
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_pablobcb$elm_lead$Container_Panel_View$oscillators(model)
					])),
				_pablobcb$elm_lead$Container_Panel_View$column(
				_elm_lang$core$Native_List.fromArray(
					[
	...
	function (msg, model) {
		...
		if (_p0.ctor === 'PanelMsg') {
			...
			return {
				...
				_1: A2(_elm_lang$core$Platform_Cmd$map, _pablobcb$elm_lead$Main$PanelMsg, _elm_lang$core$Platform_Cmd$none)
			};
		} else {
			...
			return {
				...
				_1: A2(_elm_lang$core$Platform_Cmd$map, _pablobcb$elm_lead$Main$OnScreenKeyboardMsg, _elm_lang$core$Platform_Cmd$none)
			};
		}
	});
