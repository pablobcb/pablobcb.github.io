...
var _pablobcb$elm_lead$Preset$Preset = F3(
	function (a, b, c) {
		return {filter: a, amp: b, oscs: c};
	});
		...
		A2(
			...
			A2(
				...
				function (type_) {
					return A2(
						_elm_lang$core$Json_Decode$andThen,
						A2(_elm_lang$core$Json_Decode_ops[':='], 'distortion', _elm_lang$core$Json_Decode$bool),
						function (distortion) {
							return A2(
								_elm_lang$core$Json_Decode$andThen,
											...
											return A2(
												...
												function (envelopeAmount) {
													return A2(
														...
														function (amp) {
															return _elm_lang$core$Json_Decode$succeed(
																{type_: type_, distortion: distortion, frequency: frequency, q: q, envelopeAmount: envelopeAmount, amp: amp});
														});
												});
										});
								});
			...
			return A2(
												...
												function (release) {
													return A2(
														...
														function (masterVolume) {
															return _elm_lang$core$Json_Decode$succeed(
																{attack: attack, decay: decay, sustain: sustain, release: release, masterVolume: masterVolume});
														});
												});
										});
								});
				...
				function (amp) {
					return A2(
						...
						function (oscs) {
							return _elm_lang$core$Json_Decode$succeed(
								{filter: filter, amp: amp, oscs: oscs});
						});
				});
		}));
...
var _pablobcb$elm_lead$Container_Panel_Model$knobs = function (preset) {
	return _elm_lang$core$Native_List.fromArray(
		[
			...
			A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$AmpAttack, preset.amp.attack, 0, 127, 1, 'attack', _pablobcb$elm_lead$Port$ampAttack),
			A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$AmpDecay, preset.amp.decay, 0, 127, 1, 'decay', _pablobcb$elm_lead$Port$ampDecay),
			A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$AmpSustain, preset.amp.sustain, 0, 127, 1, 'sustain', _pablobcb$elm_lead$Port$ampSustain),
			A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$AmpRelease, preset.amp.release, 0, 127, 1, 'release', _pablobcb$elm_lead$Port$ampRelease),
			...
			A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$FilterAttack, preset.filter.amp.attack, 0, 127, 1, 'attack', _pablobcb$elm_lead$Port$filterAttack),
			A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$FilterDecay, preset.filter.amp.decay, 0, 127, 1, 'decay', _pablobcb$elm_lead$Port$filterDecay),
			A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$FilterSustain, preset.filter.amp.sustain, 0, 127, 1, 'sustain', _pablobcb$elm_lead$Port$filterSustain),
			A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$FilterRelease, preset.filter.amp.release, 0, 127, 1, 'release', _pablobcb$elm_lead$Port$filterRelease),
			A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$FilterEnvelopeAmount, preset.filter.envelopeAmount, 0, 127, 1, 'Envelope amount', _pablobcb$elm_lead$Port$filterEnvelopeAmount)
		]);
};
...
var _pablobcb$elm_lead$Container_Panel_Model$init = function (preset) {
	return {
		...
		filterDistortionSwitch: A2(_pablobcb$elm_lead$Component_Switch$init, preset.filter.distortion, _pablobcb$elm_lead$Port$filterDistortion),
		filterTypeBtn: A3(
...
var _pablobcb$elm_lead$Container_Panel_Update$PresetChange = function (a) {
	...
	function (msg, model) {
		...
		switch (_p2.ctor) {
			case 'PresetChange':
				return {
					ctor: '_Tuple2',
					_0: _pablobcb$elm_lead$Container_Panel_Model$init(_p2._0),
					_1: _elm_lang$core$Platform_Cmd$none
				};
...
var _pablobcb$elm_lead$Main_Model$initModel = function (preset) {
	return {
...
var _pablobcb$elm_lead$Main_Model$Model = F5(
	function (a, b, c, d, e) {
		return {onScreenKeyboard: a, panel: b, midiConnected: c, searchingMidi: d, midiMsgInLedOn: e};
	});
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			...
			case 'OnScreenKeyboardMsg':
				var _p6 = _p0._0;
				var _p4 = A2(_pablobcb$elm_lead$Container_OnScreenKeyboard_Update$update, _p6, model.onScreenKeyboard);
				var updatedKbd = _p4._0;
				var kbdCmd = _p4._1;
				var midiMsgInLedOn = function () {
					var _p5 = _p6;
				...
				return {
					...
					_1: A2(_elm_lang$core$Platform_Cmd$map, _pablobcb$elm_lead$Main_Update$OnScreenKeyboardMsg, kbdCmd)
				};
			default:
				return {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{midiConnected: _p0._0, searchingMidi: false}),
					_1: _elm_lang$core$Platform_Cmd$none
				};
		}
	});

var _pablobcb$elm_lead$Main_View$informationBar = function (model) {
	var blinkerClass = A2(
		_elm_lang$core$Basics_ops['++'],
	...
	var midiIndicatorClass = A2(
		...
		model.searchingMidi ? 'scanning' : (model.midiConnected ? 'active' : 'inactive'));
	var velocityText = A2(
		_elm_lang$core$Basics_ops['++'],
		'Velocity is ',
		_elm_lang$core$Basics$toString(model.onScreenKeyboard.velocity));
	var endOctave = _elm_lang$core$Basics$toString(model.onScreenKeyboard.octave + 1);
	var startOctave = _elm_lang$core$Basics$toString(model.onScreenKeyboard.octave);
	var octaveText = A2(
		_elm_lang$core$Basics_ops['++'],
		'Octave is C',
		A2(
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_pablobcb$elm_lead$Main_View$informationBar(model)
			]));
};
	...
	return _elm_lang$core$Platform_Sub$batch(
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_pablobcb$elm_lead$Port$presetChange(
				function (_p1) {
					return _pablobcb$elm_lead$Main_Update$PanelMsg(
						_pablobcb$elm_lead$Container_Panel_Update$PresetChange(_p1));
				}),
				...
				function (_p2) {
					...
					return _pablobcb$elm_lead$Main_Update$PanelMsg(
						_pablobcb$elm_lead$Container_Panel_Update$KnobMsg(
							_pablobcb$elm_lead$Component_Knob$MouseMove(_p3.y)));
				})
			]));
};
	...
	main: _elm_lang$html$Html_App$programWithFlags(
		{
			init: function (preset) {
				return {
					ctor: '_Tuple2',
					_0: _pablobcb$elm_lead$Main_Model$initModel(preset),
					_1: _elm_lang$core$Platform_Cmd$none
				};
			},
									...
									return A2(
										...
										function (release) {
											return A2(
												...
												function (sustain) {
													return _elm_lang$core$Json_Decode$succeed(
														{attack: attack, decay: decay, masterVolume: masterVolume, release: release, sustain: sustain});
												});
										});
								});
						});
			...
			return A2(
													...
													return A2(
														...
														function (q) {
															return A2(
																...
																function (type_) {
																	return _elm_lang$core$Json_Decode$succeed(
																		{amp: amp, distortion: distortion, envelopeAmount: envelopeAmount, frequency: frequency, q: q, type_: type_});
																});
														});
												});
										});
				...
				function (filter) {
					return A2(
						...
						function (oscs) {
							return _elm_lang$core$Json_Decode$succeed(
								{amp: amp, filter: filter, oscs: oscs});
						});
				});
		})
};
