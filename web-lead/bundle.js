...
var _pablobcb$elm_lead$Component_Knob$view = function (model) {
	...
	var direction = (visualMinimum + (value * visualRange)) + ((_elm_lang$core$Native_Utils.cmp(model.min, 0) < 0) ? 150 : 0);
	var direction$ = A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Basics$toString(direction),
		'deg');
	var knobStyle = _elm_lang$core$Native_List.fromArray(
		[
			{
			ctor: '_Tuple2',
			_0: 'transform',
					...
					[
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								'mousedown',
								mapPosition(
									_pablobcb$elm_lead$Component_Knob$MouseDown(model.idKey))),
								A2(
								_elm_lang$html$Html_Events$on,
								'dblclick',
								...
								_elm_lang$html$Html_Attributes$style(knobStyle),
								_elm_lang$html$Html_Attributes$alt(
								_elm_lang$core$Basics$toString(model.value)),
								_elm_lang$html$Html_Attributes$src('knob-fg.svg')
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					])),
		...
		return A2(
			...
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_elm_lang$core$Native_List.fromArray(
						[
							_elm_lang$html$Html_Attributes$class('option-picker__item-id')
						]),
					_elm_lang$core$Native_List.fromArray(
						[
...
var _pablobcb$elm_lead$Component_OptionPicker$init = F2(
	function (cmdEmmiter, elems) {
		...
		return {elems: elems, currentElem: current, options: elems, cmdEmmiter: cmdEmmiter};
	});
...
var _pablobcb$elm_lead$Port$filterDistortion = _elm_lang$core$Native_Platform.outgoingPort(
	'filterDistortion',
	function (v) {
		return v;
	});
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				_elm_lang$core$Native_List.fromArray(
					[
						_elm_lang$html$Html_Attributes$href('https://github.com/pablobcb/elm-lead')
					]),
				_elm_lang$core$Native_List.fromArray(
					[
						A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								_elm_lang$html$Html_Attributes$src('gh.png'),
								_elm_lang$html$Html_Attributes$class('information-bar__gh-link')
							]),
						_elm_lang$core$Native_List.fromArray(
							[]))
					])),
...
var _pablobcb$elm_lead$Container_Panel_Model$updateFilterDistortionSwitch = F2(
	function ($switch, model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{filterDistortionSwitch: $switch});
	});
...
var _pablobcb$elm_lead$Container_Panel_Model$knobs = _elm_lang$core$Native_List.fromArray(
	[
		A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$OscMix, 0, -50, 50, 1, 'OscMix', _pablobcb$elm_lead$Port$oscsBalance),
		A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$PW, 0, 0, 127, 1, 'PW', _pablobcb$elm_lead$Port$pulseWidth),
		A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$Osc2Semitone, 0, -60, 60, 1, 'semitone', _pablobcb$elm_lead$Port$osc2Semitone),
		A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$Osc2Detune, 0, -100, 100, 1, 'detune', _pablobcb$elm_lead$Port$osc2Detune),
		A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$FM, 0, 0, 127, 1, 'FM', _pablobcb$elm_lead$Port$fmAmount),
		A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$AmpGain, 10, 0, 127, 1, 'gain', _pablobcb$elm_lead$Port$ampVolume),
		A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$AmpAttack, 1, 0, 127, 1, 'attack', _pablobcb$elm_lead$Port$ampAttack),
		A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$AmpDecay, 127, 0, 127, 1, 'decay', _pablobcb$elm_lead$Port$ampDecay),
		A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$AmpSustain, 1, 0, 127, 1, 'sustain', _pablobcb$elm_lead$Port$ampSustain),
		A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$AmpRelease, 127, 0, 127, 1, 'release', _pablobcb$elm_lead$Port$ampRelease),
		A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$FilterCutoff, 127, 0, 127, 1, 'frequency', _pablobcb$elm_lead$Port$filterCutoff),
		A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$FilterQ, 1, 0, 127, 1, 'resonance', _pablobcb$elm_lead$Port$filterQ),
		A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$FilterAttack, 0, 0, 127, 1, 'attack', _pablobcb$elm_lead$Port$filterAttack),
		A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$FilterDecay, 0, 0, 127, 1, 'decay', _pablobcb$elm_lead$Port$filterDecay),
		A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$FilterSustain, 127, 0, 127, 1, 'sustain', _pablobcb$elm_lead$Port$filterSustain),
		A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$FilterRelease, 0, 0, 127, 1, 'release', _pablobcb$elm_lead$Port$filterRelease),
		A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$FilterEnvelopeAmount, 0, 0, 127, 1, 'Envelope amount', _pablobcb$elm_lead$Port$filterEnvelopeAmount)
	]);
var _pablobcb$elm_lead$Container_Panel_Model$Model = F6(
	function (a, b, c, d, e, f) {
		return {knobs: a, filterTypeBtn: b, osc2WaveformBtn: c, osc1WaveformBtn: d, osc2KbdTrackSwitch: e, filterDistortionSwitch: f};
	});
...
var _pablobcb$elm_lead$Container_Panel_Model$init = {
	knobs: _pablobcb$elm_lead$Container_Panel_Model$knobs,
	osc2KbdTrackSwitch: A2(_pablobcb$elm_lead$Component_Switch$init, true, _pablobcb$elm_lead$Port$osc2KbdTrack),
	filterDistortionSwitch: A2(_pablobcb$elm_lead$Component_Switch$init, false, _pablobcb$elm_lead$Port$filterDistortion),
	filterTypeBtn: A2(
	...
	osc2WaveformBtn: A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				{ctor: '_Tuple2', _0: 'tri', _1: _pablobcb$elm_lead$Container_Panel_Model$Triangle},
				{ctor: '_Tuple2', _0: 'saw', _1: _pablobcb$elm_lead$Container_Panel_Model$Sawtooth},
				{ctor: '_Tuple2', _0: 'pulse', _1: _pablobcb$elm_lead$Container_Panel_Model$Square},
...
var _pablobcb$elm_lead$Container_Panel_Update$FilterDistortionToggle = function (a) {
	return {ctor: 'FilterDistortionToggle', _0: a};
};
...
var _pablobcb$elm_lead$Container_Panel_Update$update = F2(
	function (msg, model) {
		...
		switch (_p2.ctor) {
			...
			case 'FilterDistortionToggle':
				return A5(
					updateMap,
					_pablobcb$elm_lead$Component_Switch$update,
					_p2._0,
					function (_) {
						return _.filterDistortionSwitch;
					},
					_pablobcb$elm_lead$Container_Panel_Model$updateFilterDistortionSwitch,
					_pablobcb$elm_lead$Container_Panel_Update$FilterDistortionToggle);
			default:
				var _p3 = _p2._0;
				return A2(
					updateKnobs,
...
var _pablobcb$elm_lead$Container_Panel_View$instructions = function () {
	...
	return A2(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$html$Html_Attributes$class('instructions-container')
			]),
		_elm_lang$core$Native_List.fromArray(
			[
				A2(
	...
	return A3(
		...
		_elm_lang$core$Native_List.fromArray(
			[
				...
				A3(_pablobcb$elm_lead$Component_Switch$switch, 'distortion', _pablobcb$elm_lead$Container_Panel_Update$FilterDistortionToggle, model.filterDistortionSwitch),
...
var _pablobcb$elm_lead$Main$MouseUp = {ctor: 'MouseUp'};
	...
	function (msg, model) {
		...
		switch (_p0.ctor) {
			case 'MouseUp':
				...
				var panelCmd = _p1._1;
				var model$ = A2(_pablobcb$elm_lead$Main$updatePanel, updatedPanel, model);
				...
				var kbdCmd = _p2._1;
				var model$$ = A2(_pablobcb$elm_lead$Main$updateOnScreenKeyboard, updatedKbd, model$);
				return {
					ctor: '_Tuple2',
					_0: model$$,
					_1: A2(
						_elm_lang$core$Platform_Cmd$map,
						_elm_lang$core$Basics$always(_pablobcb$elm_lead$Main$MouseUp),
			...
			default:
				var _p4 = A2(_pablobcb$elm_lead$Container_OnScreenKeyboard_Update$update, _p0._0, model.onScreenKeyboard);
				var updatedKbd = _p4._0;
				var kbdCmd = _p4._1;
				return {
					ctor: '_Tuple2',
			...
			[
				...
				function (midiMsg) {
					return _pablobcb$elm_lead$Main$OnScreenKeyboardMsg(
						_pablobcb$elm_lead$Container_OnScreenKeyboard_Update$MidiMessageIn(midiMsg));
				}),
				_pablobcb$elm_lead$Port$panic(
				_elm_lang$core$Basics$always(
					_pablobcb$elm_lead$Main$OnScreenKeyboardMsg(_pablobcb$elm_lead$Container_OnScreenKeyboard_Update$Panic))),
				...
				function (_p5) {
					var _p6 = _p5;
					return _pablobcb$elm_lead$Main$PanelMsg(
						_pablobcb$elm_lead$Container_Panel_Update$KnobMsg(
							_pablobcb$elm_lead$Component_Knob$MouseMove(_p6.y)));
				})
			]));
};
