...
/***/ function(module, exports, __webpack_require__) {
	...
	var _pablobcb$elm_lead$Knob$update = F2(
		function (message, model) {
			...
			if (_p0.ctor === 'MouseDragStart') {
				...
				var _p1 = _p0._1;
				var newValue = (_elm_lang$core$Native_Utils.cmp(_p1, model.yPos) < 0) ? (model.value + model.step) : ((_elm_lang$core$Native_Utils.cmp(_p1, model.yPos) > 0) ? (model.value - model.step) : model.value);
				return ((_elm_lang$core$Native_Utils.cmp(newValue, model.max) > 0) || (_elm_lang$core$Native_Utils.cmp(newValue, model.min) < 0)) ? {ctor: '_Tuple2', _0: model, _1: _elm_lang$core$Platform_Cmd$none} : {
					ctor: '_Tuple2',
					_0: _elm_lang$core$Native_Utils.update(
						model,
						{value: newValue}),
	...
	var _pablobcb$elm_lead$Knob$knobStyle = _elm_lang$core$Native_List.fromArray(
		[
			{ctor: '_Tuple2', _0: '-webkit-user-drag', _1: 'element'},
			{ctor: '_Tuple2', _0: '-webkit-user-select', _1: 'none'}
		]);
	var _pablobcb$elm_lead$Knob$create = F4(
		function (value, min, max, step) {
			return {value: value, min: min, max: max, step: step, yPos: 0};
		});
	var _pablobcb$elm_lead$Knob$Model = F5(
		function (a, b, c, d, e) {
			return {value: a, min: b, max: c, step: d, yPos: e};
		});
	var _pablobcb$elm_lead$Knob$MouseDragStart = function (a) {
		return {ctor: 'MouseDragStart', _0: a};
	};
	var _pablobcb$elm_lead$Knob$ValueChange = F2(
		function (a, b) {
			return {ctor: 'ValueChange', _0: a, _1: b};
		});
	var _pablobcb$elm_lead$Knob$view = F2(
			...
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						'drag',
						positionMap(
							_pablobcb$elm_lead$Knob$ValueChange(cmdEmmiter))),
						A2(
						_elm_lang$html$Html_Events$on,
						'dragstart',
	...
	var _pablobcb$elm_lead$Knob$knob = F3(
		function (knobMsg, cmdEmmiter, model) {
			return A2(
				_elm_lang$html$Html_App$map,
				knobMsg,
				A2(
					_pablobcb$elm_lead$Knob$view,
					function (value) {
	...
	var _pablobcb$elm_lead$Model_Note$B = {ctor: 'B'};
	var _pablobcb$elm_lead$Model_Note$Bb = {ctor: 'Bb'};
	var _pablobcb$elm_lead$Model_Note$A = {ctor: 'A'};
	var _pablobcb$elm_lead$Model_Note$Ab = {ctor: 'Ab'};
	var _pablobcb$elm_lead$Model_Note$G = {ctor: 'G'};
	var _pablobcb$elm_lead$Model_Note$Gb = {ctor: 'Gb'};
	var _pablobcb$elm_lead$Model_Note$F = {ctor: 'F'};
	var _pablobcb$elm_lead$Model_Note$E = {ctor: 'E'};
	var _pablobcb$elm_lead$Model_Note$Eb = {ctor: 'Eb'};
	var _pablobcb$elm_lead$Model_Note$D = {ctor: 'D'};
	var _pablobcb$elm_lead$Model_Note$Db = {ctor: 'Db'};
	var _pablobcb$elm_lead$Model_Note$C = {ctor: 'C'};
	var _pablobcb$elm_lead$Model_Note$octaveNotes = _elm_lang$core$Native_List.fromArray(
		[_pablobcb$elm_lead$Model_Note$C, _pablobcb$elm_lead$Model_Note$Db, _pablobcb$elm_lead$Model_Note$D, _pablobcb$elm_lead$Model_Note$Eb, _pablobcb$elm_lead$Model_Note$E, _pablobcb$elm_lead$Model_Note$F, _pablobcb$elm_lead$Model_Note$Gb, _pablobcb$elm_lead$Model_Note$G, _pablobcb$elm_lead$Model_Note$Ab, _pablobcb$elm_lead$Model_Note$A, _pablobcb$elm_lead$Model_Note$Bb, _pablobcb$elm_lead$Model_Note$B]);

	var _pablobcb$elm_lead$Model_Midi$midiNotesDict = function () {
		var octaves = A2(
		...
		var pianoNotes = A2(
			_elm_lang$core$Basics_ops['++'],
			_elm_lang$core$List$concat(
				A2(_elm_lang$core$List$repeat, 10, _pablobcb$elm_lead$Model_Note$octaveNotes)),
			A2(_elm_lang$core$List$take, 8, _pablobcb$elm_lead$Model_Note$octaveNotes));
	...
	var _pablobcb$elm_lead$Model_Midi$noteToMidiNumber = function (note) {
		var _p0 = A2(
			_elm_lang$core$Dict$get,
			_elm_lang$core$Basics$toString(note),
			_pablobcb$elm_lead$Model_Midi$midiNotesDict);
		if (_p0.ctor === 'Just') {
			return _p0._0;
		} else {
	...
	var _pablobcb$elm_lead$Model_Midi$makeMidiMessage = F3(
		function (note, velocity, type_) {
			return _elm_lang$core$Native_List.fromArray(
				[type_, note, velocity]);
		});
	var _pablobcb$elm_lead$Model_Midi$noteOff = 128;
	var _pablobcb$elm_lead$Model_Midi$noteOffMessage = F2(
		function (note, velocity) {
			return A3(_pablobcb$elm_lead$Model_Midi$makeMidiMessage, note, velocity, _pablobcb$elm_lead$Model_Midi$noteOff);
		});
	var _pablobcb$elm_lead$Model_Midi$noteOn = 144;
	var _pablobcb$elm_lead$Model_Midi$noteOnMessage = F2(
		function (note, velocity) {
			return A3(_pablobcb$elm_lead$Model_Midi$makeMidiMessage, note, velocity, _pablobcb$elm_lead$Model_Midi$noteOn);
		});

	var _pablobcb$elm_lead$Ports$midiOutPort = _elm_lang$core$Native_Platform.outgoingPort(
		'midiOutPort',
		function (v) {
	...
	var _pablobcb$elm_lead$Ports$midiInPort = _elm_lang$core$Native_Platform.incomingPort(
		'midiInPort',
		_elm_lang$core$Json_Decode$list(_elm_lang$core$Json_Decode$int));
	var _pablobcb$elm_lead$Ports$masterVolumePort = _elm_lang$core$Native_Platform.outgoingPort(
		'masterVolumePort',
		function (v) {
			return v;
		});
	var _pablobcb$elm_lead$Ports$oscillator1WaveformPort = _elm_lang$core$Native_Platform.outgoingPort(
		'oscillator1WaveformPort',
		function (v) {
			return v;
		});
	var _pablobcb$elm_lead$Ports$oscillator2WaveformPort = _elm_lang$core$Native_Platform.outgoingPort(
		'oscillator2WaveformPort',
		function (v) {
			return v;
		});
	var _pablobcb$elm_lead$Ports$oscillator2SemitonePort = _elm_lang$core$Native_Platform.outgoingPort(
		'oscillator2SemitonePort',
		function (v) {
			return v;
		});
	var _pablobcb$elm_lead$Ports$oscillator2DetunePort = _elm_lang$core$Native_Platform.outgoingPort(
		'oscillator2DetunePort',
		function (v) {
			return v;
		});
	var _pablobcb$elm_lead$Ports$oscillatorsBalancePort = _elm_lang$core$Native_Platform.outgoingPort(
		'oscillatorsBalancePort',
		function (v) {
			return v;
		});
	var _pablobcb$elm_lead$Ports$fmAmountPort = _elm_lang$core$Native_Platform.outgoingPort(
		'fmAmountPort',
		function (v) {
			return v;
		});
	var _pablobcb$elm_lead$Ports$pulseWidthPort = _elm_lang$core$Native_Platform.outgoingPort(
		'pulseWidthPort',
		function (v) {
			return v;
		});

	var _pablobcb$elm_lead$Model_Model$setOscillator2Waveform = F2(
		function (model, waveform) {
			return _elm_lang$core$Native_Utils.update(
				model,
				{oscillator2Waveform: waveform});
		});
	var _pablobcb$elm_lead$Model_Model$setOscillator1Waveform = F2(
		function (model, waveform) {
			return _elm_lang$core$Native_Utils.update(
				model,
				{oscillator1Waveform: waveform});
		});
	var _pablobcb$elm_lead$Model_Model$findPressedNote = F2(
	...
	var _pablobcb$elm_lead$Model_Model$findPressedKey = F2(
	...
	var _pablobcb$elm_lead$Model_Model$removePressedNote = F2(
		function (model, symbol) {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
	...
	var _pablobcb$elm_lead$Model_Model$removeClickedNote = F2(
		function (model, midiNote) {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
	...
	var _pablobcb$elm_lead$Model_Model$addClickedNote = F2(
		function (model, midiNote) {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
	...
	var _pablobcb$elm_lead$Model_Model$mouseLeave = F2(
		function (model, key) {
			return _elm_lang$core$Native_Utils.update(
				model,
				{mouseHoverNote: _elm_lang$core$Maybe$Nothing, mousePressedNote: _elm_lang$core$Maybe$Nothing});
		});
	var _pablobcb$elm_lead$Model_Model$mouseEnter = F2(
		function (model, key) {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
	...
	var _pablobcb$elm_lead$Model_Model$mouseUp = function (model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{clickedAndHovering: false, mousePressedNote: _elm_lang$core$Maybe$Nothing});
	};
	var _pablobcb$elm_lead$Model_Model$mouseDown = function (model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{clickedAndHovering: true, mousePressedNote: model.mouseHoverNote});
	};
	var _pablobcb$elm_lead$Model_Model$octaveUp = function (model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				octave: A2(
	...
	var _pablobcb$elm_lead$Model_Model$octaveDown = function (model) {
		return _elm_lang$core$Native_Utils.update(
			model,
			{
				octave: A2(
	...
	var _pablobcb$elm_lead$Model_Model$velocityUp = function (model) {
		var vel = function (_) {
			return _.velocity;
		}(model);
		return _elm_lang$core$Native_Utils.update(
	...
	var _pablobcb$elm_lead$Model_Model$velocityDown = function (model) {
		var vel = function (_) {
			return _.velocity;
		}(model);
		return _elm_lang$core$Native_Utils.update(
	...
	var _pablobcb$elm_lead$Model_Model$keyToMidiNoteNumber = function (_p6) {
		var _p7 = _p6;
		var _p11 = _p7._0;
		var _p10 = _p7._1;
		return _pablobcb$elm_lead$Model_Midi$noteToMidiNumber(
			function () {
				var _p8 = _p11;
				switch (_p8.valueOf()) {
					case 'a':
						return {ctor: '_Tuple2', _0: _pablobcb$elm_lead$Model_Note$C, _1: _p10};
					case 'w':
						return {ctor: '_Tuple2', _0: _pablobcb$elm_lead$Model_Note$Db, _1: _p10};
					case 's':
						return {ctor: '_Tuple2', _0: _pablobcb$elm_lead$Model_Note$D, _1: _p10};
					case 'e':
						return {ctor: '_Tuple2', _0: _pablobcb$elm_lead$Model_Note$Eb, _1: _p10};
					case 'd':
						return {ctor: '_Tuple2', _0: _pablobcb$elm_lead$Model_Note$E, _1: _p10};
					case 'f':
						return {ctor: '_Tuple2', _0: _pablobcb$elm_lead$Model_Note$F, _1: _p10};
					case 't':
						return {ctor: '_Tuple2', _0: _pablobcb$elm_lead$Model_Note$Gb, _1: _p10};
					case 'g':
						return {ctor: '_Tuple2', _0: _pablobcb$elm_lead$Model_Note$G, _1: _p10};
					case 'y':
						return {ctor: '_Tuple2', _0: _pablobcb$elm_lead$Model_Note$Ab, _1: _p10};
					case 'h':
						return {ctor: '_Tuple2', _0: _pablobcb$elm_lead$Model_Note$A, _1: _p10};
					case 'u':
						return {ctor: '_Tuple2', _0: _pablobcb$elm_lead$Model_Note$Bb, _1: _p10};
					case 'j':
						return {ctor: '_Tuple2', _0: _pablobcb$elm_lead$Model_Note$B, _1: _p10};
					case 'k':
						return {ctor: '_Tuple2', _0: _pablobcb$elm_lead$Model_Note$C, _1: _p10 + 1};
					case 'o':
						return {ctor: '_Tuple2', _0: _pablobcb$elm_lead$Model_Note$Db, _1: _p10 + 1};
					case 'l':
						return {ctor: '_Tuple2', _0: _pablobcb$elm_lead$Model_Note$D, _1: _p10 + 1};
					case 'p':
						return {ctor: '_Tuple2', _0: _pablobcb$elm_lead$Model_Note$Eb, _1: _p10 + 1};
					default:
						return _elm_lang$core$Native_Utils.crashCase(
							'Model.Model',
							{
								start: {line: 140, column: 12},
								end: {line: 190, column: 115}
							},
							_p8)(
							A2(
								_elm_lang$core$Basics_ops['++'],
	...
	var _pablobcb$elm_lead$Model_Model$addPressedNote = F2(
		function (model, symbol) {
			return _elm_lang$core$Native_Utils.update(
				model,
				{
					pressedNotes: A2(
						...
						_elm_lang$core$Native_List.fromArray(
							[
								...
								ctor: '_Tuple2',
								_0: symbol,
								_1: _pablobcb$elm_lead$Model_Model$keyToMidiNoteNumber(
									{
										ctor: '_Tuple2',
										_0: symbol,
										_1: function (_) {
	...
	var _pablobcb$elm_lead$Model_Model$unusedKeysOnLastOctave = _elm_lang$core$Native_List.fromArray(
		[
	...
	var _pablobcb$elm_lead$Model_Model$pianoKeys = _elm_lang$core$Native_List.fromArray(
		[
			_elm_lang$core$Native_Utils.chr('a'),
	...
	var _pablobcb$elm_lead$Model_Model$allowedInputKeys = A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$Native_List.fromArray(
			[
				_elm_lang$core$Native_Utils.chr('z'),
		...
		_pablobcb$elm_lead$Model_Model$pianoKeys);
	var _pablobcb$elm_lead$Model_Model$setOscillatorsMix = F2(
		function (knobModel, model) {
			return _elm_lang$core$Native_Utils.update(
				model,
				{oscillatorsMixKnob: knobModel});
		});
	var _pablobcb$elm_lead$Model_Model$setMasterVolume = F2(
		function (knobModel, model) {
			return _elm_lang$core$Native_Utils.update(
				model,
				{masterVolumeKnob: knobModel});
		});
	var _pablobcb$elm_lead$Model_Model$setOscillator2Semitone = F2(
		function (knobModel, model) {
			return _elm_lang$core$Native_Utils.update(
				model,
				{oscillator2SemitoneKnob: knobModel});
		});
	var _pablobcb$elm_lead$Model_Model$setOscillator2Detune = F2(
		function (knobModel, model) {
			return _elm_lang$core$Native_Utils.update(
				model,
				{oscillator2DetuneKnob: knobModel});
		});
	var _pablobcb$elm_lead$Model_Model$setPulseWidth = F2(
		function (knobModel, model) {
			return _elm_lang$core$Native_Utils.update(
				model,
				{oscillator2DetuneKnob: knobModel});
		});
	var _pablobcb$elm_lead$Model_Model$setFmAmount = F2(
		function (knobModel, model) {
			return _elm_lang$core$Native_Utils.update(
				model,
				{fmAmountKnob: knobModel});
		});
	var _pablobcb$elm_lead$Model_Model$Model = function (a) {
		return function (b) {
			return function (c) {
				return function (d) {
					return function (e) {
																			...
																			return function (s) {
																				return function (t) {
																					return function (u) {
																						return function (v) {
																							return function (w) {
																								return {octave: a, velocity: b, pressedNotes: c, clickedAndHovering: d, mouseHoverNote: e, mousePressedNote: f, oscillator1Waveform: g, oscillator2Waveform: h, midiControllerPressedNotes: i, masterVolumeKnob: j, oscillatorsMixKnob: k, oscillator2SemitoneKnob: l, oscillator2DetuneKnob: m, pulseWidthKnob: n, fmAmountKnob: o, ampAttackKnob: p, ampDecayKnob: q, ampSustainKnob: r, ampReleaseKnob: s, filterAttackKnob: t, filterDecayKnob: u, filterSustainKnob: v, filterReleaseKnob: w};
																							};
																						};
																					};
																				};
	...
	var _pablobcb$elm_lead$Model_Model$Square = {ctor: 'Square'};
	var _pablobcb$elm_lead$Model_Model$Sine = {ctor: 'Sine'};
	var _pablobcb$elm_lead$Model_Model$Triangle = {ctor: 'Triangle'};
	var _pablobcb$elm_lead$Model_Model$Sawtooth = {ctor: 'Sawtooth'};
	var _pablobcb$elm_lead$Model_Model$initModel = {
		octave: 3,
		velocity: 100,
		...
		oscillator1Waveform: _pablobcb$elm_lead$Model_Model$Sawtooth,
		oscillator2Waveform: _pablobcb$elm_lead$Model_Model$Sawtooth,
		midiControllerPressedNotes: _elm_lang$core$Native_List.fromArray(
			[]),
		masterVolumeKnob: A4(_pablobcb$elm_lead$Knob$create, 10, 0, 100, 1),
		oscillatorsMixKnob: A4(_pablobcb$elm_lead$Knob$create, 0, -50, 50, 1),
		oscillator2SemitoneKnob: A4(_pablobcb$elm_lead$Knob$create, 0, -60, 60, 1),
		oscillator2DetuneKnob: A4(_pablobcb$elm_lead$Knob$create, 0, -100, 100, 1),
		fmAmountKnob: A4(_pablobcb$elm_lead$Knob$create, 0, 0, 100, 1),
		pulseWidthKnob: A4(_pablobcb$elm_lead$Knob$create, 0, 0, 100, 1),
		ampAttackKnob: A4(_pablobcb$elm_lead$Knob$create, 0, 0, 100, 1),
		ampDecayKnob: A4(_pablobcb$elm_lead$Knob$create, 0, 0, 100, 1),
		ampSustainKnob: A4(_pablobcb$elm_lead$Knob$create, 0, 0, 100, 1),
		ampReleaseKnob: A4(_pablobcb$elm_lead$Knob$create, 0, 0, 100, 1),
		filterAttackKnob: A4(_pablobcb$elm_lead$Knob$create, 0, 0, 100, 1),
		filterDecayKnob: A4(_pablobcb$elm_lead$Knob$create, 0, 0, 100, 1),
		filterSustainKnob: A4(_pablobcb$elm_lead$Knob$create, 0, 0, 100, 1),
		filterReleaseKnob: A4(_pablobcb$elm_lead$Knob$create, 0, 0, 100, 1)
	};

	var _pablobcb$elm_lead$Msg$MasterVolumeChange = function (a) {
		return {ctor: 'MasterVolumeChange', _0: a};
	};
	var _pablobcb$elm_lead$Msg$OscillatorsMixChange = function (a) {
		return {ctor: 'OscillatorsMixChange', _0: a};
	};
	var _pablobcb$elm_lead$Msg$PulseWidthChange = function (a) {
		return {ctor: 'PulseWidthChange', _0: a};
	};
	var _pablobcb$elm_lead$Msg$FMAmountChange = function (a) {
		return {ctor: 'FMAmountChange', _0: a};
	};
	var _pablobcb$elm_lead$Msg$Oscillator2DetuneChange = function (a) {
		return {ctor: 'Oscillator2DetuneChange', _0: a};
	};
	var _pablobcb$elm_lead$Msg$Oscillator2SemitoneChange = function (a) {
		return {ctor: 'Oscillator2SemitoneChange', _0: a};
	};
	var _pablobcb$elm_lead$Msg$Oscillator2WaveformChange = function (a) {
		return {ctor: 'Oscillator2WaveformChange', _0: a};
	};
	var _pablobcb$elm_lead$Msg$Oscillator1WaveformChange = function (a) {
		return {ctor: 'Oscillator1WaveformChange', _0: a};
	};
	var _pablobcb$elm_lead$Msg$MidiMessageIn = function (a) {
		return {ctor: 'MidiMessageIn', _0: a};
	};
	var _pablobcb$elm_lead$Msg$MouseClickDown = {ctor: 'MouseClickDown'};
	var _pablobcb$elm_lead$Msg$MouseClickUp = {ctor: 'MouseClickUp'};
	var _pablobcb$elm_lead$Msg$KeyOff = function (a) {
		return {ctor: 'KeyOff', _0: a};
	};
	var _pablobcb$elm_lead$Msg$KeyOn = function (a) {
		return {ctor: 'KeyOn', _0: a};
	};
	var _pablobcb$elm_lead$Msg$MouseLeave = function (a) {
		return {ctor: 'MouseLeave', _0: a};
	};
	var _pablobcb$elm_lead$Msg$MouseEnter = function (a) {
		return {ctor: 'MouseEnter', _0: a};
	};
	var _pablobcb$elm_lead$Msg$VelocityDown = {ctor: 'VelocityDown'};
	var _pablobcb$elm_lead$Msg$VelocityUp = {ctor: 'VelocityUp'};
	var _pablobcb$elm_lead$Msg$OctaveDown = {ctor: 'OctaveDown'};
	var _pablobcb$elm_lead$Msg$OctaveUp = {ctor: 'OctaveUp'};
	var _pablobcb$elm_lead$Msg$NoOp = {ctor: 'NoOp'};

	var _pablobcb$elm_lead$Update$noteOffCommand = F2(
		function (velocity, midiNoteNumber) {
			return _pablobcb$elm_lead$Ports$midiOutPort(
				A2(_pablobcb$elm_lead$Model_Midi$noteOffMessage, midiNoteNumber, velocity));
		});
	var _pablobcb$elm_lead$Update$noteOnCommand = F2(
		function (velocity, midiNoteNumber) {
			return _pablobcb$elm_lead$Ports$midiOutPort(
				A2(_pablobcb$elm_lead$Model_Midi$noteOnMessage, midiNoteNumber, velocity));
		});
	var _pablobcb$elm_lead$Update$updateMap = F6(
		function (model, childUpdate, childMsg, getChild, reduxor, msg) {
			var _p0 = A2(
				childUpdate,
				childMsg,
				getChild(model));
	...
	var _pablobcb$elm_lead$Update$update = F2(
		function (msg, model) {
			var updateMap$ = _pablobcb$elm_lead$Update$updateMap(model);
			var _p1 = msg;
			switch (_p1.ctor) {
				case 'MidiMessageIn':
					return A2(
				...
				case 'MouseClickDown':
					var model$ = _pablobcb$elm_lead$Model_Model$mouseDown(model);
					var isKeyPressed = function (midiNoteNumber) {
						return _elm_community$maybe_extra$Maybe_Extra$isJust(
							A2(_pablobcb$elm_lead$Model_Model$findPressedNote, model$, midiNoteNumber));
					};
					...
					if (_p2.ctor === 'Just') {
						...
						return isKeyPressed(_p3) ? {ctor: '_Tuple2', _0: model$, _1: _elm_lang$core$Platform_Cmd$none} : {
							...
							_0: model$,
							_1: A2(
								_pablobcb$elm_lead$Update$noteOnCommand,
								function (_) {
									return _.velocity;
								}(model$),
								_p3)
				...
				case 'MouseClickUp':
					var model$ = _pablobcb$elm_lead$Model_Model$mouseUp(model);
					var hoveringAndClickingKey = model.mousePressedNote;
					var isKeyPressed = function (midiNoteNumber) {
						return _elm_community$maybe_extra$Maybe_Extra$isJust(
							A2(_pablobcb$elm_lead$Model_Model$findPressedNote, model, midiNoteNumber));
					...
					if (_p4.ctor === 'Just') {
						...
						return isKeyPressed(_p5) ? {ctor: '_Tuple2', _0: model$, _1: _elm_lang$core$Platform_Cmd$none} : {
							...
							_0: model$,
							_1: A2(
								_pablobcb$elm_lead$Update$noteOffCommand,
								function (_) {
									return _.velocity;
								}(model$),
								_p5)
				...
				case 'MouseEnter':
					var model$ = A2(_pablobcb$elm_lead$Model_Model$mouseEnter, model, _p1._0);
					var isKeyPressed = function (midiNoteNumber) {
						return _elm_community$maybe_extra$Maybe_Extra$isJust(
							A2(_pablobcb$elm_lead$Model_Model$findPressedNote, model$, midiNoteNumber));
					};
				...
				case 'MouseLeave':
					var model$ = A2(_pablobcb$elm_lead$Model_Model$mouseLeave, model, _p1._0);
					var hoveringAndClickingKey = model.mousePressedNote;
					var isKeyPressed = function (midiNoteNumber) {
						return _elm_community$maybe_extra$Maybe_Extra$isJust(
							A2(_pablobcb$elm_lead$Model_Model$findPressedNote, model, midiNoteNumber));
				...
				case 'OctaveDown':
					return {
						ctor: '_Tuple2',
						_0: _pablobcb$elm_lead$Model_Model$octaveDown(model),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'OctaveUp':
					return {
						ctor: '_Tuple2',
						_0: _pablobcb$elm_lead$Model_Model$octaveUp(model),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'VelocityDown':
					return {
						ctor: '_Tuple2',
						_0: _pablobcb$elm_lead$Model_Model$velocityDown(model),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'VelocityUp':
					return {
						ctor: '_Tuple2',
						_0: _pablobcb$elm_lead$Model_Model$velocityUp(model),
						_1: _elm_lang$core$Platform_Cmd$none
					};
				case 'KeyOn':
					var _p11 = _p1._0;
					var hoveringAndClickingKey = model.mousePressedNote;
					var midiNoteNumber = _pablobcb$elm_lead$Model_Model$keyToMidiNoteNumber(
						{ctor: '_Tuple2', _0: _p11, _1: model.octave});
					var model$ = A2(_pablobcb$elm_lead$Model_Model$addPressedNote, model, _p11);
				...
				case 'KeyOff':
					var _p15 = _p1._0;
					var model$ = A2(_pablobcb$elm_lead$Model_Model$removePressedNote, model, _p15);
					var hoveringAndClickingKey = model.mousePressedNote;
					var releasedKey = A2(_pablobcb$elm_lead$Model_Model$findPressedKey, model, _p15);
					...
					if (_p12.ctor === 'Just') {
						...
						if (_p13.ctor === 'Just') {
							return _elm_lang$core$Native_Utils.eq(_p14, _p13._0) ? {ctor: '_Tuple2', _0: model$, _1: _elm_lang$core$Platform_Cmd$none} : {
								ctor: '_Tuple2',
								_0: model$,
								_1: A2(_pablobcb$elm_lead$Update$noteOffCommand, model.velocity, _p14)
							};
						} else {
							return {
								ctor: '_Tuple2',
				...
				case 'MasterVolumeChange':
					return A5(
						updateMap$,
						_pablobcb$elm_lead$Knob$update,
						_p1._0,
						function (_) {
							return _.masterVolumeKnob;
						},
						_pablobcb$elm_lead$Model_Model$setMasterVolume,
						_pablobcb$elm_lead$Msg$MasterVolumeChange);
				case 'OscillatorsMixChange':
					return A5(
						...
						_pablobcb$elm_lead$Model_Model$setOscillatorsMix,
						_pablobcb$elm_lead$Msg$OscillatorsMixChange);
				case 'Oscillator2SemitoneChange':
					return A5(
						...
						_pablobcb$elm_lead$Model_Model$setOscillator2Semitone,
						_pablobcb$elm_lead$Msg$Oscillator2SemitoneChange);
				case 'Oscillator2DetuneChange':
					return A5(
						...
						_pablobcb$elm_lead$Model_Model$setOscillator2Detune,
						_pablobcb$elm_lead$Msg$Oscillator2DetuneChange);
				case 'FMAmountChange':
					return A5(
						updateMap$,
						_pablobcb$elm_lead$Knob$update,
						_p1._0,
						function (_) {
							return _.fmAmountKnob;
						},
						_pablobcb$elm_lead$Model_Model$setFmAmount,
						_pablobcb$elm_lead$Msg$FMAmountChange);
				case 'PulseWidthChange':
					return A5(
						...
						_p1._0,
						function (_) {
							return _.pulseWidthKnob;
						},
						_pablobcb$elm_lead$Model_Model$setPulseWidth,
						_pablobcb$elm_lead$Msg$PulseWidthChange);
				case 'Oscillator1WaveformChange':
					var _p16 = _p1._0;
					return {
						ctor: '_Tuple2',
						_0: A2(_pablobcb$elm_lead$Model_Model$setOscillator1Waveform, model, _p16),
						_1: _pablobcb$elm_lead$Ports$oscillator1WaveformPort(
				...
				default:
					...
					return {
						ctor: '_Tuple2',
						_0: A2(_pablobcb$elm_lead$Model_Model$setOscillator2Waveform, model, _p17),
						_1: _pablobcb$elm_lead$Ports$oscillator2WaveformPort(
							_elm_lang$core$Basics$toString(_p17))
					};
			}
		});

	var _pablobcb$elm_lead$View_Keyboard$getKeyClass = F3(
	...
	var _pablobcb$elm_lead$View_Keyboard$onMouseLeave$ = function (midiNote) {
		return _elm_lang$html$Html_Events$onMouseLeave(
			_pablobcb$elm_lead$Msg$MouseLeave(midiNote));
	};
	var _pablobcb$elm_lead$View_Keyboard$onMouseEnter$ = function (midiNote) {
		return _elm_lang$html$Html_Events$onMouseEnter(
			_pablobcb$elm_lead$Msg$MouseEnter(midiNote));
	};
	var _pablobcb$elm_lead$View_Keyboard$key = F3(
		function (model, noteName, midiNote) {
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						...
						A3(_pablobcb$elm_lead$View_Keyboard$getKeyClass, model, noteName, midiNote)),
						_pablobcb$elm_lead$View_Keyboard$onMouseEnter$(midiNote),
						_pablobcb$elm_lead$View_Keyboard$onMouseLeave$(midiNote)
					]),
				_elm_lang$core$Native_List.fromArray(
					[]));
		});
	var _pablobcb$elm_lead$View_Keyboard$midiNotes = _elm_lang$core$Native_List.range(0, 127);
	var _pablobcb$elm_lead$View_Keyboard$octaveKeys = _elm_lang$core$Native_List.fromArray(
		['c', 'cs', 'd', 'ds', 'e', 'f', 'fs', 'g', 'gs', 'a', 'as', 'b']);
	var _pablobcb$elm_lead$View_Keyboard$onScreenKeyboardKeys = A2(
		_elm_lang$core$Basics_ops['++'],
		_elm_lang$core$List$concat(
			A2(_elm_lang$core$List$repeat, 10, _pablobcb$elm_lead$View_Keyboard$octaveKeys)),
		A2(_elm_lang$core$List$take, 8, _pablobcb$elm_lead$View_Keyboard$octaveKeys));
	var _pablobcb$elm_lead$View_Keyboard$keys = function (model) {
		return A3(
			_elm_lang$core$List$map2,
			_pablobcb$elm_lead$View_Keyboard$key(model),
			_pablobcb$elm_lead$View_Keyboard$onScreenKeyboardKeys,
			_pablobcb$elm_lead$View_Keyboard$midiNotes);
	};
	var _pablobcb$elm_lead$View_Keyboard$keyboard = function (model) {
		return A2(
			...
			_pablobcb$elm_lead$View_Keyboard$keys(model));
	};

	var _pablobcb$elm_lead$View_Panel$waveformSelector = F4(
		function (waveforms, getter, model, msg) {
			return A2(
				_elm_lang$html$Html$div,
				_elm_lang$core$Native_List.fromArray(
					[]),
							...
							_elm_lang$core$Native_List.fromArray(
								[
									...
									_elm_lang$core$Native_List.fromArray(
										[])),
									_elm_lang$html$Html$text(
									_elm_lang$core$Basics$toString(waveform))
								]));
					},
					waveforms));
		});
	var _pablobcb$elm_lead$View_Panel$oscillator1Waveform = A2(
		_pablobcb$elm_lead$View_Panel$waveformSelector,
		_elm_lang$core$Native_List.fromArray(
			[_pablobcb$elm_lead$Model_Model$Sawtooth, _pablobcb$elm_lead$Model_Model$Sine, _pablobcb$elm_lead$Model_Model$Triangle, _pablobcb$elm_lead$Model_Model$Square]),
		function (_) {
			return _.oscillator1Waveform;
		});
	var _pablobcb$elm_lead$View_Panel$oscillator2Waveform = A2(
		_pablobcb$elm_lead$View_Panel$waveformSelector,
		_elm_lang$core$Native_List.fromArray(
			[_pablobcb$elm_lead$Model_Model$Sawtooth, _pablobcb$elm_lead$Model_Model$Triangle, _pablobcb$elm_lead$Model_Model$Square]),
		function (_) {
	...
	var _pablobcb$elm_lead$View_Panel$nordKnob = F4(
		function (op, cmd, model, label) {
			return A2(
				...
				_elm_lang$core$Native_List.fromArray(
					[
						A3(_pablobcb$elm_lead$Knob$knob, op, cmd, model),
						A2(
						_elm_lang$html$Html$div,
						_elm_lang$core$Native_List.fromArray(
							[
	...
	var _pablobcb$elm_lead$View_InformationBar$informationBar = function (model) {
		var velocityText = A2(
			_elm_lang$core$Basics_ops['++'],
			'Velocity is ',
	...
	var _pablobcb$elm_lead$View_Dashboard$dashboard = function (model) {
		return A2(
			_elm_lang$html$Html$div,
			_elm_lang$core$Native_List.fromArray(
				[
			...
			_elm_lang$core$Native_List.fromArray(
				[
					_pablobcb$elm_lead$View_Panel$panel(model),
					_pablobcb$elm_lead$View_Keyboard$keyboard(model),
					_pablobcb$elm_lead$View_InformationBar$informationBar(model)
				]));
	};

	var _pablobcb$elm_lead$Main$handleKeyUp = F2(
		function (model, keyCode) {
			...
			var invalidKey = _elm_lang$core$Basics$not(
				A2(_elm_lang$core$List$member, symbol, _pablobcb$elm_lead$Model_Model$pianoKeys));
			return invalidKey ? _pablobcb$elm_lead$Msg$NoOp : _pablobcb$elm_lead$Msg$KeyOff(symbol);
		});
	var _pablobcb$elm_lead$Main$handleKeyDown = F2(
		function (model, keyCode) {
			...
			var symbol = _elm_lang$core$Char$toLower(
				_elm_lang$core$Char$fromCode(keyCode));
			var allowedInput = A2(_elm_lang$core$List$member, symbol, _pablobcb$elm_lead$Model_Model$allowedInputKeys);
			var unusedKeys = A2(_elm_lang$core$List$member, symbol, _pablobcb$elm_lead$Model_Model$unusedKeysOnLastOctave);
			var symbolAlreadyPressed = _elm_community$maybe_extra$Maybe_Extra$isJust(
				A2(_pablobcb$elm_lead$Model_Model$findPressedKey, model, symbol));
			if (_elm_lang$core$Basics$not(allowedInput) || ((isLastOctave && unusedKeys) || symbolAlreadyPressed)) {
				return _pablobcb$elm_lead$Msg$NoOp;
			} else {
				var _p0 = symbol;
				switch (_p0.valueOf()) {
					case 'z':
						return _pablobcb$elm_lead$Msg$OctaveDown;
					case 'x':
						return _pablobcb$elm_lead$Msg$OctaveUp;
					case 'c':
						return _pablobcb$elm_lead$Msg$VelocityDown;
					case 'v':
						return _pablobcb$elm_lead$Msg$VelocityUp;
					default:
						return _pablobcb$elm_lead$Msg$KeyOn(_p0);
				}
			}
		});
		...
		return _elm_lang$core$Platform_Sub$batch(
			_elm_lang$core$Native_List.fromArray(
				[
					...
					_pablobcb$elm_lead$Main$handleKeyDown(model)),
					_elm_lang$keyboard$Keyboard$ups(
					_pablobcb$elm_lead$Main$handleKeyUp(model)),
					_elm_lang$mouse$Mouse$downs(
					_elm_lang$core$Basics$always(_pablobcb$elm_lead$Msg$MouseClickDown)),
					_elm_lang$mouse$Mouse$ups(
					_elm_lang$core$Basics$always(_pablobcb$elm_lead$Msg$MouseClickUp)),
					_pablobcb$elm_lead$Ports$midiInPort(_pablobcb$elm_lead$Msg$MidiMessageIn)
				]));
	};
	var _pablobcb$elm_lead$Main$view = function (model) {
		return _pablobcb$elm_lead$View_Dashboard$dashboard(model);
	};
	var _pablobcb$elm_lead$Main$init = {ctor: '_Tuple2', _0: _pablobcb$elm_lead$Model_Model$initModel, _1: _elm_lang$core$Platform_Cmd$none};
	var _pablobcb$elm_lead$Main$main = {
		main: _elm_lang$html$Html_App$program(
			{init: _pablobcb$elm_lead$Main$init, view: _pablobcb$elm_lead$Main$view, update: _pablobcb$elm_lead$Update$update, subscriptions: _pablobcb$elm_lead$Main$subscriptions})
	};
...
/***/ function(module, exports) {
	...
	var AudioEngine = function AudioEngine() {
		...
		this.createOscillatorNode = function () {
			var node = _this.context.createGain();
			node.gain.value = 1;
			node.oscillators = {};
			node.type = 'sawtooth';
			node.detune = 0;
			...
			node.panic = function () {
				for (var midiNote in node.oscillators) {
			...
			node.noteOff = function (midiNote) {
				...
				if (!(midiNoteKey in node.oscillators)) return;

				node.oscillators[midiNoteKey].stop(_this.context.currentTime);
			...
			node.noteOn = function (midiNote) {
				...
				// PW
				var osc = node.type != 'square' ? _this.context.createOscillator() : _this.createPulseOscillator();

				if (node.type == 'square') osc.setWidth(node.pulseWidth);
				...
				// FM
				var fmGain = _this.context.createGain();
			...
			node.setDetune = function (detune) {
				...
				for (var midiNote in node.oscillators) {
					if (node.oscillators.hasOwnProperty(midiNote)) {
						node.oscillators[midiNote].detune.value = node.detune + node.semitone;
					}
				}
			};
			...
			node.setFMGain = function (fmGain) {
				node.fmGain = fmGain;
				for (var midiNote in node.frequency) {
					if (node.oscillators.hasOwnProperty(midiNote)) {
		...
		this.initializeOscillators = function () {
			_this.oscillator1 = _this.createOscillatorNode();
			_this.oscillator2 = _this.createOscillatorNode();
		};

		this.initializeOscillatorsGain = function () {
			_this.oscillator1Gain = _this.context.createGain();
			_this.oscillator1Gain.gain.value = .5;
			_this.oscillator1Gain.connect(_this.masterVolume);
			...
			_this.oscillator2Gain.connect(_this.masterVolume);
	  ...
	  this.fmGain.connect(this.oscillator1.frequency)*/
		...
		this.noteOn = function (midiNote /*, velocity*/) {
			...
			console.log(_this.oscillator2.oscillators);
			console.log(_this.oscillator1.frequency);
			_this.oscillator2.oscillators[midiNote.toString()].connect(_this.oscillator1.frequency[midiNote.toString()]);
		};

		this.noteOff = function (midiNote /*, velocity*/) {
			console.log(_this.oscillator2.oscillators);
			console.log(_this.oscillator1.frequency);
			_this.oscillator2.oscillators[midiNote.toString()].disconnect(_this.oscillator1.frequency[midiNote.toString()]);

			_this.oscillator1.noteOff(midiNote);
			_this.oscillator2.noteOff(midiNote);
		};
		...
		this.setFmAmount = function (fmAmount) {
			_this.oscillator1.setFMGain(fmAmount * 10);
		};
