	...
	class ADSR {
	    constructor(context) {
	        ...
	        this.setAttack = (midiValue) => {
	            MIDI_1.default.validateValue(midiValue);
...
/***/ function(module, exports, __webpack_require__) {
	...
	class BaseOscillator {
	    ...
	    noteOff(midiNote, releaseTime) {
	        MIDI_1.default.validateValue(midiNote);
...
/***/ function(module, exports, __webpack_require__) {
				...
				if (_p59.ctor === 'Nil') {
					...
					return _elm_lang$lazy$Lazy$force(
						A2(
							_elm_community$elm_lazy_list$Lazy_List_ops['+++'],
							_p59._0,
							_elm_community$elm_lazy_list$Lazy_List$flatten(_p59._1)));
				}
			});
	};
	var _elm_community$elm_lazy_list$Lazy_List$map = F2(
		function (f, list) {
			return _elm_lang$lazy$Lazy$lazy(
				function (_p60) {
					var _p61 = _p60;
					var _p62 = _elm_lang$lazy$Lazy$force(list);
					if (_p62.ctor === 'Nil') {
						return _elm_community$elm_lazy_list$Lazy_List$Nil;
					} else {
						return A2(
							_elm_community$elm_lazy_list$Lazy_List$Cons,
							f(_p62._0),
							A2(_elm_community$elm_lazy_list$Lazy_List$map, f, _p62._1));
					}
				});
		});
	var _elm_community$elm_lazy_list$Lazy_List$flatMap = function (f) {
		return function (_p63) {
			return _elm_community$elm_lazy_list$Lazy_List$flatten(
				A2(_elm_community$elm_lazy_list$Lazy_List$map, f, _p63));
		};
	};
	...
	var _elm_community$elm_lazy_list$Lazy_List$map2 = F3(
		function (f, list1, list2) {
			return _elm_lang$lazy$Lazy$lazy(
				function (_p64) {
					var _p65 = _p64;
					var _p66 = _elm_lang$lazy$Lazy$force(list1);
					if (_p66.ctor === 'Nil') {
						return _elm_community$elm_lazy_list$Lazy_List$Nil;
					} else {
						var _p67 = _elm_lang$lazy$Lazy$force(list2);
						if (_p67.ctor === 'Nil') {
							return _elm_community$elm_lazy_list$Lazy_List$Nil;
						} else {
							return A2(
								_elm_community$elm_lazy_list$Lazy_List$Cons,
								A2(f, _p66._0, _p67._0),
								A3(_elm_community$elm_lazy_list$Lazy_List$map2, f, _p66._1, _p67._1));
						}
					}
				});
		});
	...
	var _pablobcb$elm_lead$Port$oscsMix = _elm_lang$core$Native_Platform.outgoingPort(
		'oscsMix',
		function (v) {
			return v;
		});
													...
													A2(
														...
														A2(
															...
															function (waveformType) {
																return A2(
																	_elm_lang$core$Json_Decode$andThen,
																	A2(_elm_lang$core$Json_Decode_ops[':='], 'fmAmount', _elm_lang$core$Json_Decode$int),
																	function (fmAmount) {
																		return _elm_lang$core$Json_Decode$succeed(
																			{waveformType: waveformType, fmAmount: fmAmount});
																	});
															})),
													function (osc1) {
														return A2(
																						...
																						return A2(
																							...
																							function (kbdTrack) {
																								return A2(
																									...
																									function (pw) {
																										return _elm_lang$core$Json_Decode$succeed(
																											{waveformType: waveformType, semitone: semitone, detune: detune, kbdTrack: kbdTrack, pw: pw});
																									});
																							});
																					});
																			});
	...
	var _pablobcb$elm_lead$Container_Panel_Model$knobs = function (preset) {
		return _elm_lang$core$Native_List.fromArray(
			[
				A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$OscMix, preset.oscs.mix, 0, 127, 1, 'Mix', _pablobcb$elm_lead$Port$oscsMix),
				A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$PW, preset.oscs.osc2.pw, 0, 127, 1, 'Pulse width', _pablobcb$elm_lead$Port$pulseWidth),
				...
				A7(_pablobcb$elm_lead$Component_Knob$init, _pablobcb$elm_lead$Component_Knob$FM, preset.oscs.osc1.fmAmount, 0, 127, 1, 'FM amount', _pablobcb$elm_lead$Port$fmAmount),
																		...
																		A2(
																			...
																			function (fmAmount) {
																				return A2(
																					...
																					function (waveformType) {
																						return _elm_lang$core$Json_Decode$succeed(
																							{fmAmount: fmAmount, waveformType: waveformType});
																					});
																			})),
																	function (osc1) {
																		return A2(
																										...
																										return A2(
																											...
																											function (semitone) {
																												return A2(
																													...
																													function (waveformType) {
																														return _elm_lang$core$Json_Decode$succeed(
																															{detune: detune, kbdTrack: kbdTrack, pw: pw, semitone: semitone, waveformType: waveformType});
																													});
																											});
																									});
																							});
	...
	class Filter {
	    constructor(context) {
	        ...
	        this.noteOn = (midiNote) => {
	            ...
	            let filterMaxFreq = this.toFilterFrequency(this.state.envelopeAmount);
	        ...
	        this.toFilterFrequency = (midiValue) => {
	            return 1.6 * MIDI_1.default.toFrequency(midiValue);
	        };
	        ...
	        this.setQ = (midiValue) => {
	            this.biquadFilters.forEach(filter => {
	                filter.Q.value = 20 * MIDI_1.default.normalizeValue(midiValue);
	            });
	        };
	...
	class Osc1 extends BaseOscillator_1.default {
	    constructor(context) {
	        ...
	        this.noteOn = (midiNote) => {
	            ...
	            vco.frequency.value = MIDI_1.default.toFrequency(midiNote);
	        ...
	        this.setFmAmount = (fmAmount) => {
	            MIDI_1.default.validateValue(fmAmount);
	...
	class Osc2 extends BaseOscillator_1.default {
	    constructor(context) {
	        ...
	        this.noteOn = (midiNote) => {
	            ...
	            if (this.state.waveformType === Constants_1.default.WAVEFORM_TYPE.PULSE) {
	                vco = PulseOscillatorFactory_1.default
	                    .createPulseOscillator(this.context, this.widthGains[midiNote]);
	            }
	            else if (this.state.waveformType === Constants_1.default.WAVEFORM_TYPE.NOISE) {
	                vco = NoiseOscillatorFactory_1.default
	            ...
	            vco.frequency.value = MIDI_1.default.toFrequency(this.state.kbdTrack
	                ? midiNote
	                : 60);
...
/***/ function(module, exports) {
	...
	Object.defineProperty(exports, "__esModule", { value: true });
	exports.default = noiseOscillatorFactory;
...
/***/ function(module, exports, __webpack_require__) {
	...
	const pulseOscillatorFactory = {
	    createPulseOscillator: (context, widthGain) => {
	        //createPulseOscillator: (context: AudioContext, widthGain: GainNode) => {
	        const sawNode = context.createOscillator();
...
/***/ function(module, exports, __webpack_require__) {
	...
	class Synth {
	    constructor() {
	        ...
	        this.overdrive = new Overdrive_1.default(this.context);
